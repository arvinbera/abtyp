...
@section('header')
<title>ABTYP ATDC List | Admin Dashboard</title>
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                ...
                <!-- ===========================Filter Start ================================== -->
                 <form method="post" action="{{ route('admin.atdc-report-filter') }}">
                @csrf
                ...
                <div class="row">
                 ...
                 <!--  <div class="col-2">
                     <button type="submit" class="btn btn-block btn-danger">Download</button>
                  </div> -->
              ...
              <div class="card-body">
                 <form method="post"  action="{{ route('admin.atdc_pdf_submit',['download'=>'pdf']) }}">
                    @csrf
               <table id="example" class="display nowrap" style="width:100%">
                 ...
                 <tr>
                  <td>
                    ...
                    <input type="checkbox" name="atdccb[]" value="{{$atdc->id}}" id="checkAll" multiple="">
                  </td>
                    <td>{{ $loop->iteration }}</td>
                    <td>{{ $atdc->username }}</td>
                    <td>
                        <?php $newDateFormat2 = date('M/Y', strtotime( $atdc->monthly_report_month )); echo $newDateFormat2; ?>
                    ...
                    <td><a href="{{ route('admin-atdc-pdfview',['id'=>$atdc->id, 'monthly_report_month'=>$atdc->monthly_report_month,'download'=>'pdf']) }}"><i class="fas fa-download"></i></a></td>
                    <td><a href="{{url('admin/atdc-print')}}/{{$atdc->id}}" target="_blank"><i class="fas fa-print"></i></a></td>
