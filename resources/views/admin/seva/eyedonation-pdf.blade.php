...
<tbody>
  ...
  <tr>
    ...
    <td class="tg-baqh">{{ $items->eye_donate_no_of_eye_donation }}</td>
  ...
  <tr>
    ...
    <td class="tg-baqh">{{ $items->eye_donate_no_ofeye_bank }}</td>
  ...
  <tr>
    ...
    <td class="tg-baqh">{{ $items->eye_donate_kry_members }}</td>
   
  </tr>

   <tr>
    <td class="tg-0lax">Special Thanks To</td>
    <td class="tg-baqh">{{ $items->eye_donate_special_thanks_to }}</td>
  ...
  <tr>
    ...
    <td class="tg-baqh">{{ $items->eye_donate_brief_report }}</td>
   ...
   <tr>
    ...
    <td class="tg-baqh">{{ $items->eye_donate_prepared_by }}</td>
