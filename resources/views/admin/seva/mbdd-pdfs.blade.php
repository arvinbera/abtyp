...
<tbody>
  ...
  <tr>
    ...
    <td class="tg-baqh">{{ $items->name_of_camps }}</td>
  ...
  <tr>
    ...
    <td class="tg-baqh">{{ $items->date }}</td>
  ...
  <tr>
    ...
    <td class="tg-baqh">{{ $items->time }}</td>
   
  </tr>

   <tr>
    <td class="tg-0lax">Venue</td>
    <td class="tg-baqh">{{ $items->venue }}</td>
  ...
  <tr>
    ...
    <td class="tg-baqh">{{ $items->name_of_blood_bank }}</td>
   ...
   <tr>
    ...
    <td class="tg-baqh">{{ $items->in_association }}</td>
   
  </tr>
   <tr>
    <td class="tg-0lax">Total Units Collected</td>
    <td class="tg-baqh">{{ $items->total_units_collected }}</td>
   
  </tr>
   <tr>
    <td class="tg-0lax">Camp Convenors</td>
    <td class="tg-baqh">{{ $items->camp_convenors }}</td>
   
  </tr>
   <tr>
    <td class="tg-0lax">Key Members</td>
    <td class="tg-baqh">{{ $items->key_members }}</td>
   
  </tr>
   <tr>
    <td class="tg-0lax">Sponsors</td>
    <td class="tg-baqh">{{ $items->sponsors }}</td>
   
  </tr>
   <tr>
    <td class="tg-0lax">Special Thanks To</td>
    <td class="tg-baqh">{{ $items->special_thatnks_to }}</td>
   
  </tr> 
  <tr>
    <td class="tg-0lax">Brief Report</td>
    <td class="tg-baqh">{{ $items->brief_reports }}</td>
   
  </tr> 
  <tr>
    <td class="tg-0lax">Chaitra Aatma</td>
    <td class="tg-baqh">{{ $items->chaitra_aatma }}</td>
   
  </tr>
  
   <tr>
    <td class="tg-0lax">ABTYP Members</td>
    <td class="tg-baqh">{{ $items->abtyp_members }}</td>
   
  </tr>
  
   <tr>
    <td class="tg-0lax">Chief Guest</td>
    <td class="tg-baqh">{{ $items->chief_guest }}</td>
   
  </tr>
  
   <tr>
    <td class="tg-0lax">Guests</td>
    <td class="tg-baqh">{{ $items->guests }}</td>
   
  </tr>
  
     <tr>
    <td class="tg-0lax">Total</td>
    <td class="tg-baqh">{{ $items->total }}</td>
   
  </tr>   <tr>
    <td class="tg-0lax">Prepared By</td>
    <td class="tg-baqh">{{ $items->mbdd_prepared_by }}</td>
