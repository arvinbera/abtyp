...
@section('header')
<title>ABTYP CHOKA SATKAR List | Admin Dashboard</title>
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
               <!-- ===========================Filter Start ================================== -->
                 <form method="post" action="{{ route('admin.chokasatar-report-filter') }}">
                @csrf
              ...
              <div class="card-body">
                <form method="post"  action="{{ route('admin.chokasatar_pdf_submit',['download'=>'pdf']) }}">
                    @csrf
               <table id="example" class="display nowrap" style="width:100%">
                 ...
                 <tr>
                  <td>
                    ...
                    <input type="checkbox" name="atdccb[]" value="{{$cs_list->id}}" id="checkAll" multiple="">
                  </td>
                    ...
                    <td><a href="{{ route('admin-chokasatkar-pdfview',['id'=>$cs_list->id, 'monthly_report_month'=>$cs_list->monthly_report_month,'download'=>'pdf']) }}"><i class="fas fa-download"></i></a></td>
                   <td><a href="{{url('admin/cs_list-print')}}/{{$cs_list->id}}" target="_blank"><i class="fas fa-print"></i></a></td>
