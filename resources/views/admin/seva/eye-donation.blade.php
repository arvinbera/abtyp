...
@section('header')
<title>ABTYP EYE DONATION List | Admin Dashboard</title>
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <!-- ===========================Filter Start ================================== -->
                 <form method="post" action="{{ route('admin.eyedonation-report-filter') }}">
                @csrf
              ...
              <div class="card-body">
                <form method="post"  action="{{ route('admin.eyedonation_pdf_submit',['download'=>'pdf']) }}">
                    @csrf
               <table id="example" class="display nowrap" style="width:100%">
                 ...
                 <tr>
                  <td>
                    ...
                    <input type="checkbox" name="atdccb[]" value="{{$eyedonate->id}}" id="checkAll" multiple="">
                  </td>
                    ...
                    <td>{{ $eyedonate->eye_donate_prepared_by }}</td>
                     <td><a href="{{ route('admin-eyedonation-pdfview',['id'=>$eyedonate->id, 'monthly_report_month'=>$eyedonate->monthly_report_month,'download'=>'pdf']) }}"><i class="fas fa-download"></i></a></td>
                    <td><a href="{{url('admin/eyedonate-print')}}/{{$eyedonate->id}}" target="_blank"><i class="fas fa-print"></i></a></td>
