...
@section('header')
<title>ABTYP AMPK List | Admin Dashboard</title>
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <!-- ===========================Filter Start ================================== -->
                 <form method="post" action="{{ route('admin.ampk-report-filter') }}">
                @csrf
              ...
              <div class="card-body">
                 <form method="post"  action="{{ route('admin.ampk_pdf_submit',['download'=>'pdf']) }}">
                    @csrf
               <table id="example" class="display nowrap" style="width:100%">
                 ...
                 <tr>
                   <td>
                    ...
                    <input type="checkbox" name="atdccb[]" value="{{$ampk->id}}" id="checkAll" multiple="">
                  </td>
                    <td>{{ $loop->iteration }}</td>
                    <td>{{ $ampk->username }}</td>
                    <td><?php $newDateFormat2 = date('M/Y', strtotime($ampk->monthly_report_month)); echo $newDateFormat2; ?>
                    ...
                    <td><a href="{{ route('admin-ampk-pdfview',['id'=>$ampk->id, 'monthly_report_month'=>$ampk->monthly_report_month,'download'=>'pdf']) }}"><i class="fas fa-download"></i></a></td>
                   <td><a href="{{url('admin/ampk-print')}}/{{$ampk->id}}" target="_blank"><i class="fas fa-print"></i></a></td>
