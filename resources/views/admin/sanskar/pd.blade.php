      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
           ...
           <!-- ===========================Filter Start ================================== -->
                 <form method="post" action="{{ route('admin.pd-report-filter') }}">
                @csrf
              ...
              <div class="card-body">
                <form method="post"  action="{{ route('admin.pd_pdf_submit',['download'=>'pdf']) }}">
                    @csrf
               <table id="example" class="display nowrap" style="width:100%">
                 ...
                 <tr>
                   <td>
                    ...
                    <input type="checkbox" name="atdccb[]" value="{{$pd->id}}" id="checkAll" multiple="">
                  </td>
                    ...
                    <td><?php $newDateFormat2 = date('M/Y', strtotime($pd->monthly_report_month)); echo $newDateFormat2; ?>
                     ...
                     <td><a href="{{ route('admin-pd-pdfview',['id'=>$pd->id, 'monthly_report_month'=>$pd->monthly_report_month,'download'=>'pdf']) }}"><i class="fas fa-download"></i></a></td>
                    <td><a href="{{url('admin/pd-print')}}/{{$pd->id}}" target="_blank"><i class="fas fa-print"></i></a></td>
