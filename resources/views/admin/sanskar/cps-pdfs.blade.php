...
<tbody>
  ...
  <tr>
    ...
    <td class="tg-baqh">{{ $items->cps_date }}</td>
  ...
  <tr>
    ...
    <td class="tg-baqh">{{ $items->cps_time }}</td>
   
  </tr>

   <tr>
    <td class="tg-0lax">Venue</td>
    <td class="tg-baqh">{{ $items->cps_venue }}</td>
  ...
  <tr>
    ...
    <td class="tg-baqh">{{ $items->cps_in_association }}</td>
  ...
  <tr>
    ...
    <td class="tg-baqh">{{ $items->cps_chaitra_aatma }}</td>
   ...
   <tr>
    ...
    <td class="tg-baqh">{{ $items->cps_abtyp_members }}</td>
   
  </tr>
   
   <tr>
    <td class="tg-0lax">Chief Guest</td>
    <td class="tg-baqh">{{ $items->cps_chief_guest }}</td>
   
  </tr>
   <tr>
    <td class="tg-0lax">Guests</td>
    <td class="tg-baqh">{{ $items->cps_guest }}</td>
   
  </tr>
   <tr>
    <td class="tg-0lax">Total Presence</td>
    <td class="tg-baqh">{{ $items->cps_total_presesnt }}</td>
  </tr>
   <tr>
    <td class="tg-0lax">Conveynor</td>
    <td class="tg-baqh">{{ $items->cps_conveynor }}</td>
  </tr>

   <tr>
    <td class="tg-0lax">Key Members</td>
    <td class="tg-baqh">{{ $items->cps_key_member }}</td>
  </tr>

   <tr>
    <td class="tg-0lax">Sponsors</td>
    <td class="tg-baqh">{{ $items->cps_sponcer }}</td>
  </tr>

   <tr>
    <td class="tg-0lax">Special Thanks</td>
    <td class="tg-baqh">{{ $items->cps_special_thanks }}</td>
  </tr>

   <tr>
    <td class="tg-0lax">Brief Report</td>
    <td class="tg-baqh">{{ $items->cps_brief_report }}</td>
  </tr>
  <tr>
    <td class="tg-0lax">Prepared By</td>
    <td class="tg-baqh">{{ $items->cps_prepared_by }}</td>
  </tr>
