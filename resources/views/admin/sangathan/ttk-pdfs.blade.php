...
<tbody>
  ...
  <tr>
    ...
    <td class="tg-baqh">{{ $items->tkm_name }}</td>
  ...
  <tr>
    ...
    <td class="tg-baqh">{{ $items->tkm_time }}</td>
   
  </tr>

   <tr>
    <td class="tg-0lax">Venue</td>
    <td class="tg-baqh">{{ $items->tkm_venue }}</td>
  ...
  <tr>
    ...
    <td class="tg-baqh">{{ $items->tkm_in_association }}</td>
  ...
  <tr>
    ...
    <td class="tg-baqh">{{ $items->tkm_no_of_participants }}</td>
   ...
   <tr>
    ...
    <td class="tg-baqh">{{ $items->tkm_convenors }}</td>
   
  </tr>
   
   <tr>
    <td class="tg-0lax">Key Members</td>
    <td class="tg-baqh">{{ $items->tkm_key_members }}</td>
   
  </tr>
   <tr>
    <td class="tg-0lax">Sponsors</td>
    <td class="tg-baqh">{{ $items->tkm_sponsors }}</td>
   
  </tr>
   <tr>
    <td class="tg-0lax">Special Thanks To</td>
    <td class="tg-baqh">{{ $items->tkm_special_thanks_to }}</td>
  </tr>
   <tr>
    <td class="tg-0lax">Brief Report</td>
    <td class="tg-baqh">{{ $items->tkm_brief_report }}</td>
  </tr>

   <tr>
    <td class="tg-0lax">Chaitra Aatma</td>
    <td class="tg-baqh">{{ $items->tkm_chaitra_aatma }}</td>
  </tr>

   <tr>
    <td class="tg-0lax">ABTYP Members</td>
    <td class="tg-baqh">{{ $items->tkm_abtyp_members }}</td>
  </tr>

   <tr>
    <td class="tg-0lax">Chief Guest</td>
    <td class="tg-baqh">{{ $items->tkm_chief_guest }}</td>
  </tr>

   <tr>
    <td class="tg-0lax">Guests</td>
    <td class="tg-baqh">{{ $items->tkm_guest }}</td>
  </tr>
  <tr>
    <td class="tg-0lax">Total</td>
    <td class="tg-baqh">{{ $items->tkm_total }}</td>
  </tr>
  <tr>
    <td class="tg-0lax">Prepared By</td>
    <td class="tg-baqh">{{ $items->tkm_prepared_by }}</td>
  </tr>
