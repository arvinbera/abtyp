        ...
        <div class="row">
          <div class="col-12">
            ...
            <div class="card">
              ...
              <!-- ===========================Filter Start ================================== -->
                 <form method="post" action="{{ route('admin.yuvasangam-report-filter') }}">
                @csrf
            ...
            <div class="table-responsive">
              ...
              <div class="card-body">
                 <form method="post"  action="{{ route('admin.yuvasangam_pdf_submit',['download'=>'pdf']) }}">
                    @csrf
               <table id="example" class="display nowrap" style="width:100%">
                 ...
                 <tr>
                   <td>
                    ...
                    <input type="checkbox" name="atdccb[]" value="{{$yuvasangam->id}}" id="checkAll" multiple="">
                  </td>
                   <td>{{ $loop->iteration }}</td>
                    ...
                    <td><?php $newDateFormat2 = date('M/Y', strtotime($yuvasangam->monthly_report_month)); echo $newDateFormat2; ?>
                     ...
                     <td><a href="{{ route('admin-yuvasangam-pdfview',['id'=>$yuvasangam->id, 'monthly_report_month'=>$yuvasangam->monthly_report_month,'download'=>'pdf']) }}"><i class="fas fa-download"></i></a></td>
                    <td><a href="{{url('admin/yuvasangam-print')}}/{{$yuvasangam->id}}" target="_blank"><i class="fas fa-print"></i></a></td>
