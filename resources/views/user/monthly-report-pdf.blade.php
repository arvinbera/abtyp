...
<body>
      @if ($items1->total_no_of_billing !=null) 
...
<tbody>
  ...
  <tr>
    ...
    <td class="tg-baqh">{{ $items1->address }}</td>
  ...
  <tr>
   ...
   <tr>
    <td class="tg-0lax">Amount of Special Donation of the month</td>
    <td class="tg-baqh">{{ $items1->special_donation }}</td>
   
  </tr>
   <tr>
    <td class="tg-0lax">Number of Doctor Visit in Center</td>
  ...
  <tr>
    <td class="tg-0lax">Brief Reporting (Problems can also be mentioned)</td>
...
<div style="page-break-before:always">&nbsp;</div> 
@endif
     @if ($items4->yuva_vahini_date_form !=null) 
<table id="customers">
    <tr>
...
<tbody>
  ...
  <tr>
   ...
   <tr>
    <td class="tg-0lax">Total Distance Covered</td>
...
<div style="page-break-before:always">&nbsp;</div> 
@endif
     @if ($items5->eye_donate_no_of_eye_donation !=null) 
...
<tbody>
  ...
  <tr>
    <td class="tg-0lax">Name of Eye Bank</td>
...
<div style="page-break-before:always">&nbsp;</div> 
@endif
     @if ($items7->choka_satkar_date_form !=null) 
<table id="customers">
    <tr>
...
<tbody>
 ...
 <tr>
  ...
  <!-- <tr>
   ...
   <tr>
    <td class="tg-0lax"> Sanskarak Name (2 - 3)</td>
...
<!--  <tr>
  ...
  <tr>
    <td class="tg-0lax">In Association (if any) (3 - 4)</td>
  ...
  <tr>
   ...
   <tr>
    <td class="tg-0lax">Total Number of New Samayik Sadhak</td>
    <td class="tg-baqh">{{ $items9->ss_total_no_of_samayik_sadhak }}</td>
   
  </tr>
   <tr>
    <td class="tg-0lax"> Number of Samayik Kits Distributed</td>
...
<tbody>
  ...
  <tr>
    <td class="tg-0lax">Faculty Name (4 - 5 Names)</td>
    <td class="tg-baqh">{{ $items11->cps_Faculty_Name }}</td>
  </tr>
  <!-- 
  <tr>
    <td class="tg-0lax">Prepared By</td>
...
<div style="page-break-before:always">&nbsp;</div> <table id="customers">
     @endif
     @if ($items18->ys_no_new_members !=null) 
  <table id="customers">
    <tr>
...
<tbody>
  ...
  <tr>
    <td class="tg-0lax">TYP (New Members added this month)</td>
  ...
  <tr>
    <td class="tg-0lax">Current Total Strength</td>
...
<tbody>
  ...
  <tr>
    <td class="tg-0lax">Event Name</td>
