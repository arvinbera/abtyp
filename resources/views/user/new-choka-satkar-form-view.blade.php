   ...
   <!--               <form method="post" action="{{ route('user.monthly-report_filer') }}">
                ...
                <div class="row">
                        ...
                        <div class="col-12">
                            <div class="card">
									<div class="card-header">
										<div class="card-title">Choka Satkar Monthly Report</div>
									</div>
									<div class="card-body">
                  ...
                  <tr>
                    ...
                    <th class="wd-15p border-bottom-0">Sponsor</th>
                 ...
                 <tr>
                    ...
                    <td>{{ $monthyreport->choka_satkar_no_of_days }}</td>
                    <td>{{ $monthyreport->choka_satkar_amount_paid }}</td>
                    <td>{{ $monthyreport->choka_satkar_sponsor }}</td>
                    <td>{{ $monthyreport->choka_satkar_special_thanks_to }}</td>
                    <td>{{ $monthyreport->choka_satkar_brief_reports }}</td>
                    ...
                    <td>
                        ...
                        @else
                         ...
                         <a href="{{url('user/choka-satkar-edit-view')}}/{{$monthyreport->id}}"><button class="btn btn-info w-100">Edit</button></a>
                         @endif
                    ...
                    <td><a href="{{ url('user/chokasatar_pdfview')}}/{{$monthyreport->id}}/{download}"><button class="btn btn-success w-100"><i class="fa fa-file-pdf-o" aria-hidden="true"></i> Pdf</button></a></td>
                    <td><a href="{{url('user/cs_list_print')}}/{{$monthyreport->id}}" target="_blank"><button class="btn btn-info w-100"><i class="fa fa-print" aria-hidden="true"></i> Print</button></td>
