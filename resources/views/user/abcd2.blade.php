        ...
        <div class="page-main">
            ...
            <div class="app-content main-content">
                <div class="side-app">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <form method="post" action="{{ route('submit-edit-of-mbdd-report') }}" enctype="multipart/form-data" class="dropzone">
                 @csrf
                 
                 <input type="hidden" name="monthlyreportid" value="{{$detail_report[0]->monthly_report_id}}">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="email" class="form-control" id="exampleInputEmail1" placeholder="Enter email" name="email_id" value="{{$detail_report[0]->username}}" readonly="">
        ...
        {{-- ==================================Seva Form================================================================= --}}              
              ...
              <div class="card card-primary collapsed-card">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="venue" placeholder="Venue" name="venue" value="{{$detail_mbdd_report->venue}}">
                    <input type="hidden" name="id" value="{{$detail_mbdd_report->id}}">
                    
                  </div>

                  <div class="form-group">
                    <label for="name_of_blood_bank">Name of Blood Bank</label>
                    <input type="text" class="form-control" id="name_of_blood_bank" placeholder="Name of Blood Bank" name="name_of_blood_bank" value="{{$detail_mbdd_report->name_of_blood_bank}}">
                  </div>

                  <div class="form-group">
                    <label for="in_association">In Association(if any)</label>
                    <input type="text" class="form-control" id="in_association" placeholder="In Association(if any)" name="in_association" value="{{$detail_mbdd_report->in_association}}">
                  </div>

                  <div class="form-group">
                    <label for="total_units_collected">Total Units Collected</label>
                    <input type="text" class="form-control" id="total_units_collected" placeholder="Total Units Collected" name="total_units_collected" value="{{$detail_mbdd_report->total_units_collected}}">
                  </div>

                  <div class="form-group">
                    <label for="camp_convenors">Camp Convenors</label>
                    <input type="text" class="form-control" id="camp_convenors" placeholder="Camp Convenors" name="camp_convenors" value="{{$detail_mbdd_report->camp_convenors}}">
                  </div>

                   <div class="form-group">
                    <label for="key_members">Key Members</label>
                    <input type="text" class="form-control" id="key_members" placeholder="Key Members" name="key_members" value="{{$detail_mbdd_report->key_members}}">
                  </div>

                  <div class="form-group">
                    <label for="sponsors">Sponsors</label>
                    <input type="text" class="form-control" id="sponsors" placeholder="Sponsors" name="sponsors" value="{{$detail_mbdd_report->sponsors}}">
                  </div>

                  <div class="form-group">
                    <label for="special_thatnks_to">Special Thanks To</label>
                    <input type="text" class="form-control" id="special_thatnks_to" placeholder="Special Thanks To" name="special_thatnks_to" value="{{$detail_mbdd_report->special_thatnks_to}}">
                  </div>

                  <div class="form-group">
                    <label for="brief_reports">Brief Report</label>
                    <input type="text" class="form-control" id="brief_reports" placeholder="Brief Report" name="brief_reports"value="{{$detail_mbdd_report->brief_reports}}">
                  </div>

                  <div class="form-group">
                    <label for="chaitra_aatma">Chaitra Aatma</label>
                    <input type="text" class="form-control" id="chaitra_aatma" placeholder="Chaitra Aatma" name="chaitra_aatma" value="{{$detail_mbdd_report->chaitra_aatma}}">
                  </div>

                  <div class="form-group">
                    <label for="abtyp_members">ABTYP Members</label>
                    <input type="text" class="form-control" id="abtyp_members" placeholder="ABTYP Members" name="abtyp_members" value="{{$detail_mbdd_report->abtyp_members}}">
                  </div>

                  <div class="form-group">
                    <label for="chief_guest">Chief Guest</label>
                    <input type="text" class="form-control" id="chief_guest" placeholder="Chief Guest" name="chief_guest" value="{{$detail_mbdd_report->chief_guest}}">
                  </div>


                  <div class="form-group">
                    <label for="guests">Guests</label>
                    <input type="text" class="form-control" id="guests" placeholder="Guests" name="guests" value="{{$detail_mbdd_report->guests}}">
                  </div>
          ...
          <div class="form-group">
                 ...
                 <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="filled_by" placeholder="Filled By" name="filled_by" value="{{$detail_report[0]->filled_by}}">
