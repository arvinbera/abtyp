        ...
        <div class="page-main">
            ...
            <div class="app-content main-content">
                <div class="side-app">
                    ...
                    <div class="row">
                        <div class="col-12">
         <form method="post" action="{{ route('submit-edit-of-ttf-report') }}" enctype="multipart/form-data" class="dropzone">
                 @csrf
                 
                 <input type="hidden" name="monthlyreportid" value="">
                 <input type="hidden" name="id" value="{{$detail_ttf_report->id}}">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="email" class="form-control" id="exampleInputEmail1" placeholder="Enter email" name="email_id" value="{{$ttf_report[0]->email_id}}" readonly="">
        ...
        {{-- ==================================Seva Form================================================================= --}}              
              ...
              <div class="card card-primary collapsed-card">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="venue" placeholder="Venue" name="venue" value="{{$detail_ttf_report->ttf_venue}}">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="in_association" placeholder="In Association(if any)" name="in_association" value="{{$detail_ttf_report->ttf_in_associati}}">
                  </div>
                  
                  
                  <div class="form-group">
                    <label for="venue">Number Of participants</label>
                    <input type="text" class="form-control" id="venue" placeholder="Venue" name="number_of_participants" value="{{$detail_ttf_report->ttf_number_Of_participants}}">
                    
                    
                  </div>

                  <div class="form-group">
                    <label for="venue">NDRF TRAINER'S NAME</label>
                    <input type="text" class="form-control" id="venue" placeholder="Venue" name="ndrf_trainer_name" value="{{$detail_ttf_report->ttf_ndrf_trainer_ame}}">
                  ...
                  <div class="form-group">
                    <label for="venue">CONVENORS</label>
                    <input type="text" class="form-control" id="venue" placeholder="Venue" name="convenors" value="{{$detail_ttf_report->ttf_convenors}}">
                   
                    
                  </div>

                  <div class="form-group">
                    <label for="venue">KEY MEMBERS</label>
                    <input type="text" class="form-control" id="venue" placeholder="Venue" name="key_members" value="{{$detail_ttf_report->ttf_key_members}}">
                    
                    
                  </div>

                  <div class="form-group">
                    <label for="venue">SPONSORS</label>
                    <input type="text" class="form-control" id="venue" placeholder="Venue" name="sponsors" value="{{$detail_ttf_report->ttf_sponsors}}">
                    
                    
                  </div>

                  <div class="form-group">
                    <label for="venue">SPECIAL THANKS TO</label>
                    <input type="text" class="form-control" id="venue" placeholder="Venue" name="special_thanks_to" value="{{$detail_ttf_report->ttf_special_thanks_to}}">
                    
                    
                  </div>

                  <div class="form-group">
                    <label for="venue">BRIEF REPORT</label>
                    <input type="text" class="form-control" id="venue" placeholder="Venue" name="brief_report" value="{{$detail_ttf_report->ttf_brief_reports}}">
                   
                    
                  </div>

                  <div class="form-group">
                    <label for="venue">CHAITRA AATMA</label>
                    <input type="text" class="form-control" id="venue" placeholder="Venue" name="chaitra_aatma" value="{{$detail_ttf_report->ttf_chaitra_aatma}}">
                    
                    
                  </div>

                  <div class="form-group">
                    <label for="venue">ABTYP MEMBERS</label>
                    <input type="text" class="form-control" id="venue" placeholder="Venue" name="abtyp_members" value="{{$detail_ttf_report->ttf_abtyp_members}}">
                    
                    
                  </div>

                  <div class="form-group">
                    <label for="venue">CHIEF GUEST</label>
                    <input type="text" class="form-control" id="venue" placeholder="Venue" name="chief_guests" value="{{$detail_ttf_report->ttf_chief_guest}}">
                    
                    
                  </div>

                  <div class="form-group">
                    <label for="venue">GUESTS</label>
                    <input type="text" class="form-control" id="venue" placeholder="Venue" name="guests" value="{{$detail_ttf_report->ttf_guests}}">
          ...
          <div class="form-group">
                  ...
                  <div class="form-group">
                   ...
                   <input type="hidden" name="monthlyreportid" value="{{$ttf_report[0]->monthly_report_id}}">
                 <div class="form-group">
                    <label for="filled_by">Filled By</label>
                    <input type="text" class="form-control" id="filled_by" placeholder="Filled By" name="filled_by" value="{{$ttf_report[0]->filled_by}}">
