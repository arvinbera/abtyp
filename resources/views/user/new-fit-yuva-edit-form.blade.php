        ...
        <div class="page-main">
            ...
            <div class="app-content main-content">
                <div class="side-app">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <form method="post" action="{{ route('submit-fit-yuva') }}" enctype="multipart/form-data" class="dropzone">
                 @csrf
                 <input type="hidden" name="monthly_report_id" id="monthly_report_id" value="{{$monthly_report[0]->fit_yuva_monthly_report_id}}">
                 <input type="hidden" name="id" value="{{$fit_yuva_report->id}}">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="email" class="form-control" id="exampleInputEmail1" placeholder="Enter email" name="email_id" value="{{$monthly_report[0]->email_id}}" readonly="">
              ...
              <div class="card card-primary collapsed-card">
                ...
                <div class="card-body">
                  ...
                  {{-- <div class="form-group">
                    ...
                    <input type="date" class="form-control" id="fit_yuva_date" placeholder="" name="fit_yuva_date" value="{{$fit_yuva_report->fit_yuva_date}}">
                  </div>

                  <div class="form-group">
                    <label for="fit_yuva_time">Time</label>
                    <input type="time" class="form-control" id="fit_yuva_time" placeholder="" name="fit_yuva_time" value="{{$fit_yuva_report->fit_yuva_time}}">
                  </div>

                  <div class="form-group">
                    <label for="fit_yuva_venue">Venue</label>
                    <input type="text" class="form-control" id="fit_yuva_venue" placeholder="" name="fit_yuva_venue" value="{{$fit_yuva_report->fit_yuva_venue}}">
                  </div>

                  <div class="form-group">
                    <label for="fit_yuva_in_association">In Association(if any)</label>
                    <input type="text" class="form-control" id="fit_yuva_in_association" placeholder="" name="fit_yuva_in_association" value="{{$fit_yuva_report->fit_yuva_in_association}}">
                  </div>

                  <div class="form-group">
                    <label for="fit_yuva_event">Event Name</label>
                    <input type="text" class="form-control" id="fit_yuva_event" placeholder="" name="fit_yuva_event" value="{{$fit_yuva_report->fit_yuva_event}}">
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="fit_yuva_no_of_participants" placeholder="" name="fit_yuva_no_of_participants" value="{{$fit_yuva_report->fit_yuva_no_of_participants}}">
                  </div>

                  <div class="form-group">
                    <label for="fit_yuva_convenors">Convenors</label>
                    <input type="text" class="form-control" id="fit_yuva_convenors" placeholder="" name="fit_yuva_convenors" value="{{$fit_yuva_report->fit_yuva_convenors}}">
                  </div>

                  <div class="form-group">
                    <label for="fit_yuva_key_members">Key Members</label>
                    <input type="text" class="form-control" id="fit_yuva_key_members" placeholder="" name="fit_yuva_key_members" value="{{$fit_yuva_report->fit_yuva_key_members}}">
                  </div>

                  <div class="form-group">
                    <label for="fit_yuva_sponsors">Sponsors</label>
                    <input type="text" class="form-control" id="fit_yuva_sponsors" placeholder="" name="fit_yuva_sponsors" value="{{$fit_yuva_report->fit_yuva_sponsors}}">
                  </div>


                  <div class="form-group">
                    <label for="fit_yuva_special_thanks_to">Special Thanks To</label>
                    <input type="text" class="form-control" id="fit_yuva_special_thanks_to" placeholder="" name="fit_yuva_special_thanks_to" value="{{$fit_yuva_report->fit_yuva_special_thanks_to}}">
                  </div>

                   <div class="form-group">
                    <label for="fit_yuva_brief_report">Brief Report</label>
                    <input type="text" class="form-control" id="fit_yuva_brief_report" placeholder="" name="fit_yuva_brief_report" value="{{$fit_yuva_report->fit_yuva_brief_report}}">
                  </div>
                  ...
                  <div class="form-group">
                   ...
                   <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="fit_yuva_chaitrs_aatma" placeholder="" name="fit_yuva_chaitrs_aatma" value="{{$fit_yuva_report->fit_yuva_chaitrs_aatma}}">
                  </div>

                   <div class="form-group">
                    <label for="fit_yuva_abtyp_members">ABTYP Members</label>
                    <input type="text" class="form-control" id="fit_yuva_abtyp_members" placeholder="" name="fit_yuva_abtyp_members" value="{{$fit_yuva_report->fit_yuva_abtyp_members}}">
                  </div>

                  <div class="form-group">
                    <label for="fit_yuva_chief_guest">Chief Guest</label>
                    <input type="text" class="form-control" id="fit_yuva_chief_guest" placeholder="" name="fit_yuva_chief_guest" value="{{$fit_yuva_report->fit_yuva_chief_guest}}">
                  </div>

                  <div class="form-group">
                    <label for="fit_yuva_guest">Guests</label>
                    <input type="text" class="form-control" id="fit_yuva_guest" placeholder="" name="fit_yuva_guest" value="{{$fit_yuva_report->fit_yuva_guest}}">
                  </div>
...
<font color="red">(Images / Videos / Presentation)</font>
          ...
          <div class="form-group">
                 ...
                 <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="filled_by" placeholder="Filled By" name="filled_by" value="{{$monthly_report[0]->filled_by}}">
