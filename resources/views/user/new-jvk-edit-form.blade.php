        ...
        <div class="page-main">
            ...
            <div class="app-content main-content">
                <div class="side-app">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <form method="post" action="{{ route('submit-edit-jvk') }}" enctype="multipart/form-data" class="dropzone">
                 @csrf
                 <input type="hidden" name="monthly_report_id" id="monthly_report_id" value="{{$monthly_report[0]->jvk_monthly_report_id}}">
                 <input type="hidden" name="id" value="{{$jvk_report->id}}">
                <div class="card-body">
              ...
              <div class="card card-primary collapsed-card">
                ...
                <div class="card-body">
                 ...
                 {{--  <div class="form-group">
                    ...
                    <input type="date" class="form-control" id="jvk_date_form" placeholder="" name="jvk_date" value="{{$jvk_report->jvk_date}}">
                  </div>
                  <div class="form-group">
                    <label for="jvk_date_to">Date To</label>
                    <input type="date" class="form-control" id="jvk_date_to" placeholder="" name="jvk_time" value="{{$jvk_report->jvk_time}}">
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="jvk_venue" placeholder="" name="jvk_venue" value="{{$jvk_report->jvk_venue}}">
                  </div>

                  <div class="form-group">
                    <label for="jvk_in_association">In Association(if any)</label>
                    <input type="text" class="form-control" id="jvk_in_association" placeholder="" name="jvk_in_association" value="{{$jvk_report->jvk_in_association}}">
                  </div>
                  
                    <label for="">ABOUT THE PROGRAM</label>
                    <div class="form-group">
                    <label for="jvk_teachers_name">Teachers Name</label>
                    <input type="text" class="form-control" id="jvk_teachers_name" placeholder="" name="jvk_teachers_name" value="{{$jvk_report->jvk_teachers_name}}">
                  </div>
                  <div class="form-group">
                    <label for="jvk_no_of_the_paticipants">NUMBER OF PARTICIPANTS: </label>
                    <input type="text" class="form-control" id="jvk_no_of_the_paticipants" placeholder="" name="jvk_no_of_participants" value="{{$jvk_report->jvk_no_of_participants}}">
                  </div>
                  
                  <div class="form-group">
                    <label for="jvk_conveynor">Conveynor</label>
                    <input type="text" class="form-control" id="jvk_conveynor" placeholder="" name="jvk_convenors" value="{{$jvk_report->jvk_no_of_participants}}">
                  </div>
                  
                  <div class="form-group">
                    <label for="jvk_key_members">Key Members</label>
                    <input type="text" class="form-control" id="jvk_key_members" placeholder="" name="jvk_key_members" value="{{$jvk_report->jvk_key_members}}">
                  </div>
                   <div class="form-group">
                    <label for="jvk_sponcer">Sponsors</label>
                    <input type="text" class="form-control" id="jvk_sponcer" placeholder="" name="jvk_sponsor" value="{{$jvk_report->jvk_sponsor}}">
                  </div>
                       <div class="form-group">
                    <label for="jvk_special_thanks">Special Thanks</label>
                    <input type="text" class="form-control" id="jvk_special_thanks" placeholder="" name="jvk_special_thanks_to" value="{{$jvk_report->jvk_special_thanks_to}}">
                  </div>
                ...
                <!--    <div class="form-group">
                   ...
                   <div class="form-group">
                    <label for="jvk_brief_report">Brief Report</label>
                    <textarea class="form-control" id="jvk_brief_report" placeholder="NOT MORE THAN 500 WORDS" name="jvk_brief_report" value="{{$jvk_report->jvk_brief_report}}"></textarea>
                  </div>
                    <!--<div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="jvk_chaitra_aatma" placeholder="" name="jvk_chaitra_aatma" value="{{$jvk_report->jvk_chaitra_aatma}}">
                  </div>

                  <div class="form-group">
                    <label for="jvk_abtyp_members">ABTYP Members</label>
                    <input type="text" class="form-control" id="jvk_abtyp_members" placeholder="" name="jvk_abtyp_members" value="{{$jvk_report->jvk_abtyp_members}}">
                  </div>


                  <div class="form-group">
                    <label for="jvk_chief_guest">Chief Guest</label>
                    <input type="text" class="form-control" id="jvk_chief_guest" placeholder="" name="jvk_chief_guest" value="{{$jvk_report->jvk_chief_guest}}">
                  </div>


                  <div class="form-group">
                    <label for="jvk_guest">Guests</label>
                    <input type="text" class="form-control" id="jvk_guest" placeholder="" name="jvk_guest" value="{{$jvk_report->jvk_guest}}">
                  </div>
