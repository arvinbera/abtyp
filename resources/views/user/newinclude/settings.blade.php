 <!-- Start Switcher -->
                ...
                <div class="row">
                    <div class="predefined_styles">
                        <div class="swichermainleft">
                            <div class="p-3">
                                <a href="{{url('/')}}" class="btn btn-primary btn-block mt-0" target="_blank">View Website</a>
                                <!--<a href="#" class="btn btn-secondary btn-block">Buy Now</a>
                                <a href="#" class="btn btn-warning btn-block">Our Portfolio</a>-->
                            </div>
                        </div>
                        <!--<div class="swichermainleft">
    ...
    <!-- <div id="global-loader" >
        <img src="{{url('/')}}/public/admin/assets/images/svgs/loader.svg" alt="loader">
    </div> -->
    <!--- End Global-loader-->