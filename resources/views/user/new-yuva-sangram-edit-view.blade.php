        ...
        <div class="page-main">
            ...
            <div class="app-content main-content">
                <div class="side-app">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <form method="post" action="{{ route('submit-edit-yuva-sangram') }}" enctype="multipart/form-data" class="dropzone">
                 @csrf
                 <input type="hidden" name="monthly_report_id" id="monthly_report_id" value="{{$monthly_report[0]->ys_monthly_report_id}}">
                 <input type="hidden" name="id" value="{{$yuva_sangram_report->id}}">
                <div class="card-body">
              ...
              <div class="card card-primary collapsed-card">
                ...
                <div class="card-body">
                 ...
                 {{--  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="ys_no_new_members" placeholder="" name="typ_ys_no_new_members" value="{{$yuva_sangram_report->typ_ys_no_new_members}}">
                  </div>
                   <div class="form-group">
                    <label for="ys_no_new_members">TKM (New Members added this month)</label>
                    <input type="text" class="form-control" id="ys_tkm" placeholder="" name="tkm_ys_no_new_members" value="{{$yuva_sangram_report->tkm_ys_no_new_members}}">
                  </div>

                  <div class="form-group">
                    <label for="ys_conveynor">Current Total Strength</label>
                    <input type="text" class="form-control" id="ys_conveynor" placeholder="" name="ys_conveynor" value="{{$yuva_sangram_report->ys_conveynor}}">
                  </div>

                  <div class="form-group">
                    <label for="ys_special_thanks_to">Special Thanks To</label>
                    <input type="text" class="form-control" id="ys_special_thanks_to" placeholder="" name="ys_special_thanks_to" value="{{$yuva_sangram_report->ys_special_thanks_to}}">
                  </div>

                  <div class="form-group">
                    <label for="ys_brief_reports">Brief Report</label>
                    <input type="text" class="form-control" id="ys_brief_reports" placeholder="" name="ys_brief_reports" value="{{$yuva_sangram_report->ys_brief_reports}}">
                  </div>
