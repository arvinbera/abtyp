        ...
        <div class="page-main">
            ...
            <div class="app-content main-content">
                <div class="side-app">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <form method="post" action="{{ route('submit-edit-ampk') }}" enctype="multipart/form-data" class="dropzone">
                 @csrf
                 <input type="text" name="monthly_report_id" id="monthly_report_id" value="{{$monthly_report[0]->ampk_monthly_report_id}}">
                <input type="hidden" name="id" value="{{$ampk_report->id}}">
                 <div class="card-body">
              ...
              <div class="card card-primary collapsed-card">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="ampk_in_association" placeholder="In Association(if any)" name="ampk_in_association" value="{{$ampk_report->ampk_in_association}}">
                  </div>

                  <div class="form-group">
                    <label for="ampk_chaitra_atma_visited">Chaitra Aatma's Visited</label>
                    <input type="text" class="form-control" id="ampk_chaitra_atma_visited" placeholder="Chaitra Aatma's Visited" name="ampk_chaitra_atma_visited" value="{{$ampk_report->ampk_chaitra_atma_visited}}">
                  </div>

                  <div class="form-group">
                    <label for="ampk_date">Date</label>
                    <input type="date" class="form-control" id="ampk_date" placeholder="Date" name="ampk_date" value="{{$ampk_report->ampk_date}}">
                  </div>

                  <div class="form-group">
                    <label for="ampk_conveynor">Convenors</label>
                    <input type="text" class="form-control" id="ampk_conveynor" placeholder="Conveynor" name="ampk_conveynor" value="{{$ampk_report->ampk_conveynor}}">
                  </div>

                  <div class="form-group">
                    <label for="ampk_key_members">Key Members</label>
                    <input type="text" class="form-control" id="ampk_key_members" placeholder="Key Members" name="ampk_key_members" value="{{$ampk_report->ampk_key_members}}">
                  </div>

                  <div class="form-group">
                    <label for="ampk_sponsors">Sponsors</label>
                    <input type="text" class="form-control" id="ampk_sponsors" placeholder="Sponsors" name="ampk_sponsors" value="{{$ampk_report->ampk_sponsors}}">
                  </div>

                  <div class="form-group">
                    <label for="ampk_special_thanks_to">Special Thanks To</label>
                    <input type="text" class="form-control" id="ampk_special_thanks_to" placeholder="Special Thanks To" name="ampk_special_thanks_to" value="{{$ampk_report->ampk_special_thanks_to}}">
                  </div>

                  <div class="form-group">
                    <label for="ampk_brief_report">Brief Report</label>
                    <input type="text" class="form-control" id="ampk_brief_report" placeholder="Brief Report" name="ampk_brief_report" value="{{$ampk_report->ampk_brief_report}}">
                  </div>
