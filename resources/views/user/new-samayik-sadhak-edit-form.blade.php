        ...
        <div class="page-main">
            ...
            <div class="app-content main-content">
                <div class="side-app">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <form method="post" action="{{ route('submit-edit-sadhak') }}" enctype="multipart/form-data" class="dropzone">
                 @csrf
                 <input type="hidden" name="monthly_report_id" id="monthly_report_id" value="{{$monthly_report[0]->ss_monthly_report_id}}">
                 <input type="hidden" name="id" value="{{$sadhak_report->id}}">
                <div class="card-body">
                ...
                <div class="card-body" >
                 ...
                 {{--  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="ss_venue" placeholder="" name="ss_venue" value="{{$sadhak_report->ss_venue}}">
                  </div>

                  <div class="form-group">
                    <label for="ss_in_association">In Association (if any) (3 - 4)</label>
                    <input type="text" class="form-control" id="ss_in_association" placeholder="" name="ss_in_association" value="{{$sadhak_report->ss_in_association}}">
                  </div>

                   <div class="form-group">
                    <label for="ss_jain_samayik_festival">Jain Samayik Festival</label>
                    <input type="text" class="form-control" id="ss_jain_samayik_festival" placeholder="" name="ss_jain_samayik_festival" value="{{$sadhak_report->ss_jain_samayik_festival}}">
                  </div>

                  <div class="form-group">
                    <label for="ss_total_participants">Total Participants</label>
                    <input type="text" class="form-control" id="ss_total_participants" placeholder="" name="ss_total_participants" value="{{$sadhak_report->ss_total_participants}}">
                  </div>

                  <div class="form-group">
                    <label for="ss_total_no_of_samayik_sadhak">Total Number of New Samayik Sadhak</label>
                    <input type="text" class="form-control" id="ss_total_no_of_samayik_sadhak" placeholder="" name="ss_total_no_of_samayik_sadhak" value="{{$sadhak_report->ss_total_no_of_samayik_sadhak}}">
                  </div>

                   <div class="form-group">
                    <label for="ss_donation_of_samayik_kits">Number of Samayik Kits Distributed</label>
                    <input type="text" class="form-control" id="ss_donation_of_samayik_kits" placeholder="" name="ss_donation_of_samayik_kits" value="{{$sadhak_report->ss_donation_of_samayik_kits}}">
                  </div>

                  <div class="form-group">
                    <label for="ss_conveynor">Convenors </label>
                    <input type="text" class="form-control" id="ss_conveynor" placeholder="" name="ss_conveynor" value="{{$sadhak_report->ss_conveynor}}">
                  </div>

                  <div class="form-group">
                    <label for="ss_key_member">Key Members</label>
                    <input type="text" class="form-control" id="ss_key_member" placeholder="" name="ss_key_member" value="{{$sadhak_report->ss_key_member}}">
                  </div>

                  <div class="form-group">
                    <label for="ss_special_thanks_to">Special Thanks To</label>
                    <input type="text" class="form-control" id="ss_special_thanks_to" placeholder="" name="ss_special_thanks_to" value="{{$sadhak_report->ss_special_thanks_to}}">
                  </div>

                  <div class="form-group">
                    <label for="ss_brief_report">Brief Report</label>
                    <input type="text" class="form-control" id="ss_brief_report" placeholder="" name="ss_brief_report" value="{{$sadhak_report->ss_brief_report}}">
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="chaitra_aatma" placeholder="" name="ss_chaitra_aatma" value="{{$sadhak_report->ss_chaitra_aatma}}">
                  </div>

                   <div class="form-group">
                    <label for="tapoyaga_prepared_by">ABTYP Members</label>
                    <input type="text" class="form-control" id="abtyp_members" placeholder="" name="ss_abtyp_members" value="{{$sadhak_report->ss_abtyp_members}}">
                  </div>
