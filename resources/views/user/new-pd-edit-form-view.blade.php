        ...
        <div class="page-main">
            ...
            <div class="app-content main-content">
                <div class="side-app">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <form method="post" action="{{ route('submit-edit-pd') }}" enctype="multipart/form-data" class="dropzone">
                 @csrf
                 <input type="hidden" name="monthly_report_id" id="monthly_report_id" value="{{$monthly_report[0]->pd_monthly_report_id}}">
                 <input type="hidden" name="id" value="{{$pd_report->id}}">
                <div class="card-body">
              ...
              <div class="card card-primary collapsed-card">
                ...
                <div class="card-body" >
                  ...
                  {{-- <div class="form-group">
                    ...
                    <input type="date" class="form-control" id="pd_date_form" placeholder="" name="pd_date" value="{{$pd_report->pd_date}}">
                  </div>
                  <div class="form-group">
                    <label for="pd_date_to">Date To</label>
                    <input type="date" class="form-control" id="pd_date_to" placeholder="" name="pd_time" value="{{$pd_report->pd_time}}">
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="pd_venue" placeholder="" name="pd_venue" value="{{$pd_report->pd_venue}}">
                  </div>

                  <div class="form-group">
                    <label for="pd_in_association">In Association(if any)</label>
                    <input type="text" class="form-control" id="pd_in_association" placeholder="" name="pd_in_association" value="{{$pd_report->pd_in_association}}">
                  </div>
                  
                    <label for="">ABOUT THE PROGRAM</label>
                    <div class="form-group">
                    <label for="pd_teachers_name">Teachers Name</label>
                    <input type="text" class="form-control" id="pd_teachers_name" placeholder="" name="pd_teachers_name" value="{{$pd_report->pd_teachers_name}}">
                  </div>
                  <div class="form-group">
                    <label for="pd_no_of_the_paticipants">NUMBER OF PARTICIPANTS: </label>
                    <input type="text" class="form-control" id="pd_no_of_participants" placeholder="" name="pd_no_of_the_paticipants" value="{{$pd_report->pd_no_of_the_paticipants}}">
                  </div>
                  
                  <div class="form-group">
                    <label for="pd_conveynor">Conveynor</label>
                    <input type="text" class="form-control" id="pd_conveynor" placeholder="" name="pd_convenors" value="{{$pd_report->pd_convenors}}">
                  </div>
                  
                  <div class="form-group">
                    <label for="pd_key_members">Key Members</label>
                    <input type="text" class="form-control" id="pd_key_members" placeholder="" name="pd_kry_member" value="{{$pd_report->pd_kry_member}}">
                  </div>
                   <div class="form-group">
                    <label for="pd_sponcer">Sponsors</label>
                    <input type="text" class="form-control" id="pd_sponcer" placeholder="" name="pd_sponsors" value="{{$pd_report->pd_sponsors}}">
                  </div>
                       <div class="form-group">
                    <label for="pd_special_thanks">Special Thanks</label>
                    <input type="text" class="form-control" id="pd_special_thanks" placeholder="" name="pd_special_thanks_to" value="{{$pd_report->pd_special_thanks_to}}">
                  </div>
                 ...
                 <!--   <div class="form-group">
                   ...
                   <div class="form-group">
                    <label for="pd_brief_report">Brief Report</label>
                    <textarea class="form-control" id="pd_brief_report" placeholder="NOT MORE THAN 500 WORDS" name="pd_brief_report" value="{{$pd_report->pd_brief_report}}"></textarea>
                  </div>
                    <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="pd_chaitra_aatma" placeholder="" name="pd_chaitra_aatma" value="{{$pd_report->pd_chaitra_aatma}}">
                  </div>

                  <div class="form-group">
                    <label for="pd_abtyp_members">ABTYP Members</label>
                    <input type="text" class="form-control" id="pd_abtyp_members" placeholder="" name="pd_abtyp_members" value="{{$pd_report->pd_abtyp_members}}">
                  </div>


                  <div class="form-group">
                    <label for="pd_chief_guest">Chief Guest</label>
                    <input type="text" class="form-control" id="pd_chief_guest" placeholder="" name="pd_chief_guest" value="{{$pd_report->pd_chief_guest}}">
                  </div>


                  <div class="form-group">
                    <label for="pd_guest">Guests</label>
                    <input type="text" class="form-control" id="pd_guest" placeholder="" name="pd_guest" value="{{$pd_report->pd_guest}}">
                  </div>
