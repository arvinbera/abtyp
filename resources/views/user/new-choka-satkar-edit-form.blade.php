        ...
        <div class="page-main">
            ...
            <div class="app-content main-content">
                <div class="side-app">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <form method="post" action="{{ route('submit-edit-choka-satkar') }}" enctype="multipart/form-data" class="dropzone">
                 @csrf
                 <input type="hidden" name="monthly_report_id" id="monthly_report_id" value="{{$monthly_report[0]->choka_satkar_monthly_report_id}}">
                 <input type="hidden" name="id" value="{{$chokasatkar_report->id}}">
                <div class="card-body">
                 ...
                 {{--  <div class="form-group">
                  ...
                  <!--<div class="form-group">
                   ...
                   <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="choka_satkar_no_of_days" placeholder="Number of Days" name="choka_satkar_no_of_days" value="{{$chokasatkar_report->choka_satkar_no_of_days}}">
                  </div>

                  <div class="form-group">
                    <label for="choka_satkar_amount_paid">Amount Paid</label>
                    <input type="number" class="form-control" id="choka_satkar_amount_paid" placeholder="Amount Paid" name="choka_satkar_amount_paid" value="{{$chokasatkar_report->choka_satkar_amount_paid}}">
                  </div>

                  <div class="form-group">
                    <label for="choka_satkar_sponsor">Sponsor</label>
                    <input type="text" class="form-control" id="choka_satkar_sponsor" placeholder="Sponsor" name="choka_satkar_sponsor" value="{{$chokasatkar_report->choka_satkar_sponsor}}">
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="choka_satkar_special_thanks_to" placeholder="Special Thanks To" name="choka_satkar_special_thanks_to" value="{{$chokasatkar_report->choka_satkar_special_thanks_to}}">
                  </div>

                  <div class="form-group">
                    <label for="choka_satkar_brief_reports">Brief Report</label>
                    <input type="text" class="form-control" id="choka_satkar_brief_reports" placeholder="Brief Report" name="choka_satkar_brief_reports" value="{{$chokasatkar_report->choka_satkar_brief_reports}}">
                  </div>
