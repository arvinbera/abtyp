   ...
   <!--               <form method="post" action="{{ route('user.monthly-report_filer') }}">
                ...
                <div class="row">
                        ...
                        <div class="col-12">
                            <div class="card">
									<div class="card-header">
										<div class="card-title">TTF Monthly Report</div>
									</div>
									<div class="card-body">
                  ...
                  <tr>
                    ...
                    <th class="wd-15p border-bottom-0">NDRF Trainer's Name</th>
                 ...
                 <tr>
                    ...
                    <td>{{ $monthyreport->ttf_date }}</td>
                    <td>{{ $monthyreport->ttf_time }}</td>
                    <td>{{ $monthyreport->ttf_venue }}</td>
                    <td>{{ $monthyreport->ttf_in_associati }}</td>
                    <td>{{ $monthyreport->ttf_number_Of_participants }}</td>
                    <td>{{ $monthyreport->ttf_ndrf_trainer_ame }}</td>
                    <td>{{ $monthyreport->ttf_convenors }}</td>
                    <td>{{ $monthyreport->ttf_key_members }}</td>
                    <td>{{ $monthyreport->ttf_sponsors }}</td>
                    <td>{{ $monthyreport->ttf_special_thanks_to }}</td>
                    <td>{{ $monthyreport->ttf_brief_reports }}</td>
                    <td>{{ $monthyreport->ttf_chaitra_aatma }}</td>
                    <td>{{ $monthyreport->ttf_abtyp_members }}</td>
                    <td>{{ $monthyreport->ttf_chief_guest }}</td>
                    <td>{{ $monthyreport->ttf_guests }}</td>
                    ...
                    <td>
                        ...
                        @else
                         ...
                         <a href="{{url('user/ttf-edit-view/')}}/{{$monthyreport->id}}"><button class="btn btn-info w-100">Edit</button></a>
                         @endif
                    ...
                    <td><a href="{{ url('user/ttf-pdfview')}}/{{$monthyreport->id}}/{download}"><button class="btn btn-success w-100"><i class="fa fa-file-pdf-o" aria-hidden="true"></i> Pdf</button></a></td>
                    <td><a href="{{url('user/ttf-print')}}/{{$monthyreport->id}}" target="_blank"><button class="btn btn-info w-100"><i class="fa fa-print" aria-hidden="true"></i> Print</button></td>
