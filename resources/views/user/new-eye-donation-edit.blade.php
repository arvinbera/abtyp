        ...
        <div class="page-main">
            ...
            <div class="app-content main-content">
                <div class="side-app">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <form method="post" action="{{ route('submit-edit-eye-donation') }}" enctype="multipart/form-data" class="dropzone">
                 @csrf
                 <input type="hidden" name="monthly_report_id" id="monthly_report_id" value="{{$monthly_report[0]->eye_donate_monthly_report_id}}">
                 <input type="hidden" name="id" value="{{$eye_donation_report->id}}">
                <div class="card-body">
              ...
              <div class="card card-primary collapsed-card">
                ...
                <div class="card-body">
                 ...
                 {{--  <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="eye_donate_no_of_eye_donation" placeholder="Number of Eye Donation" name="eye_donate_no_of_eye_donation" value="{{$eye_donation_report->eye_donate_no_of_eye_donation}}">
                  </div>

                  <div class="form-group">
                    <label for="eye_donate_no_ofeye_bank">Number of Eye Bank</label>
                    <input type="number" class="form-control" id="eye_donate_no_ofeye_bank" placeholder="Number of Eye Bank" name="eye_donate_no_ofeye_bank" value="{{$eye_donation_report->eye_donate_no_ofeye_bank}}">
                  </div>

                  <div class="form-group">
                    <label for="eye_donate_kry_members">Key Members</label>
                    <input type="text" class="form-control" id="eye_donate_kry_members" placeholder="Key Members" name="eye_donate_kry_members" value="{{$eye_donation_report->eye_donate_kry_members}}">
                  </div>

                  <div class="form-group">
                    <label for="eye_donate_special_thanks_to">Special Thanks To</label>
                    <input type="text" class="form-control" id="eye_donate_special_thanks_to" placeholder="Special Thanks To" name="eye_donate_special_thanks_to" value="{{$eye_donation_report->eye_donate_special_thanks_to}}">
                  </div>

                   <div class="form-group">
                    <label for="eye_donate_brief_report">Brief Report</label>
                    <input type="text" class="form-control" id="eye_donate_brief_report" placeholder="Brief Report" name="eye_donate_brief_report" value="{{$eye_donation_report->eye_donate_brief_report}}">
                  </div>
