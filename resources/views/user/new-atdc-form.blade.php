        ...
        <div class="page-main">
            ...
            <div class="app-content main-content">
                <div class="side-app">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <form method="post" action="{{ route('user.atdc-report-submit') }}" enctype="multipart/form-data" class="dropzone">
                 @csrf
              ...
              <div class="card card-primary collapsed-card">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="special_activity" name="special_activity" placeholder="No of doctor visit in center">
                  </div>
