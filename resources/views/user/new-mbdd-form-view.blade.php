   ...
   <!--               <form method="post" action="{{ route('user.monthly-report_filer') }}">
                ...
                <div class="row">
                        ...
                        <div class="col-12">
                            <div class="card">
									<div class="card-header">
										<div class="card-title">MBDD Monthly Report</div>
									</div>
									<div class="card-body">
                  ...
                  <tr>
                    ...
                    <th class="wd-15p border-bottom-0">Name of Blood Bank</th>
                    <th class="wd-15p border-bottom-0">In Association</th>
                    <th class="wd-15p border-bottom-0">Total Units Collected</th>
                    <th class="wd-15p border-bottom-0">Camp Convenors</th>
                 ...
                 <tr>
                    ...
                    <td>{{ $monthyreport->date }}</td>
                    <td>{{ $monthyreport->venue }}</td>
                    <td>{{ $monthyreport->name_of_blood_bank }}</td>
                    <td>{{ $monthyreport->in_association }}</td>
                    <td>{{ $monthyreport->total_units_collected }}</td>
                    <td>{{ $monthyreport->camp_convenors }}</td>
                    <td>{{ $monthyreport->key_members }}</td>
                    <td>{{ $monthyreport->sponsors }}</td>
                    <td>{{ $monthyreport->special_thatnks_to }}</td>
                    <td>{{ $monthyreport->brief_reports }}</td>
                    <td>{{ $monthyreport->chaitra_aatma }}</td>
                    <td>{{ $monthyreport->abtyp_members }}</td>
                    <td>{{ $monthyreport->chief_guest }}</td>
                    <td>{{ $monthyreport->guests }}</td>
                    ...
                    <td>
                        ...
                        @else
                         ...
                         <a href="{{url('user/abcd2')}}/{{$monthyreport->id}}"><button class="btn btn-info w-100">Edit</button></a>
                         @endif
                    ...
                    <td><a href="{{ url('user/mbdd_pdfview')}}/{{$monthyreport->id}}/{download}"><button class="btn btn-success w-100"><i class="fa fa-file-pdf-o" aria-hidden="true"></i> Pdf</button></a></td>
                    <td><a href="{{url('user/mbdd_print')}}/{{$monthyreport->id}}" target="_blank"><button class="btn btn-info w-100"><i class="fa fa-print" aria-hidden="true"></i> Print</button></td>
