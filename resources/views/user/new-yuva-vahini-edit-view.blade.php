        ...
        <div class="page-main">
            ...
            <div class="app-content main-content">
                <div class="side-app">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <form method="post" action="{{ route('submit-edit-yuva-vahini') }}" enctype="multipart/form-data" class="dropzone">
                 @csrf
                 <input type="hidden" name="monthlyreportid" value="{{$monthly_report[0]->yuva_vahini_monthly_report_id}}">
                 <input type="hidden" name="id" value="{{$detail_yuva_report->id}}">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="email" class="form-control" id="exampleInputEmail1" placeholder="Enter email" name="email_id" value="{{$monthly_report[0]->username}}" readonly="">
                 ...
                 {{--  <div class="form-group">
                  ...
                  <!--<div class="form-group">
                   ...
                   <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="yuva_vahini_no_Of_days" placeholder="Number of Days" name="yuva_vahini_no_Of_days" value="{{$detail_yuva_report->yuva_vahini_no_Of_days}}">
                  </div>

                   <div class="form-group">
                    <label for="yuva_vahini_no_of_members">Number of Members</label>
                    <input type="number" class="form-control" id="yuva_vahini_no_of_members" placeholder="Number of Members" name="yuva_vahini_no_of_members" value="{{$detail_yuva_report->yuva_vahini_no_of_members}}">
                  </div>

                  <div class="form-group">
                    <label for="yuva_vahini_total_distance">Total Distance Covered</label>
                    <input type="number" class="form-control" id="yuva_vahini_total_distance" placeholder="Total Distance" name="yuva_vahini_total_distance" value="{{$detail_yuva_report->yuva_vahini_total_distance}}">
                  </div>

                  <div class="form-group">
                    <label for="yuva_vahini_no_of_yv_jackets_collected">Number of YV Jackets Collected</label>
                    <input type="number" class="form-control" id="yuva_vahini_no_of_yv_jackets_collected" placeholder="Number of YV Jackets Collected" name="yuva_vahini_no_of_yv_jackets_collected" value="{{$detail_yuva_report->yuva_vahini_no_of_yv_jackets_collected}}">
                  </div>

                  <div class="form-group">
                    <label for="yuva_vahini_availed_abtyp_accomodation">Availed Abtyp's Accomodation</label>
                    <input type="text" class="form-control" id="yuva_vahini_availed_abtyp_accomodation" placeholder="Availed Abtyp's Accomodation" name="yuva_vahini_availed_abtyp_accomodation" value="{{$detail_yuva_report->yuva_vahini_availed_abtyp_accomodation}}">
                  </div>

                   <div class="form-group">
                    <label for="yuva_vahini_availed_satkar">Availed Satkar</label>
                    <input type="text" class="form-control" id="yuva_vahini_availed_satkar" placeholder="Availed Satkar" name="yuva_vahini_availed_satkar" value="{{$detail_yuva_report->yuva_vahini_availed_satkar}}">
                  </div>

                  <div class="form-group">
                    <label for="yuva_vahini_brief_report">Brief Report</label>
                    <input type="text" class="form-control" id="yuva_vahini_brief_report" placeholder="Brief Report" name="yuva_vahini_brief_report" value="{{$detail_yuva_report->yuva_vahini_brief_report}}">
                  </div>
