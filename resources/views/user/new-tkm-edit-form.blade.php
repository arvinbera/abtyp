        ...
        <div class="page-main">
            ...
            <div class="app-content main-content">
                <div class="side-app">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <form method="post" action="{{ route('submit-edit-tkm') }}" enctype="multipart/form-data" class="dropzone">
                 @csrf
                 <input type="hidden" name="monthly_report_id" id="monthly_report_id" value="{{$monthly_report[0]->tkm_monthly_report_id}}">
                 <input type="hidden" name="id" value="{{$tkm_report->id}}">
                <div class="card-body">
              ...
              <div class="card card-primary collapsed-card">
                ...
                <div class="card-body">
                  ...
                  {{-- <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="tkm_name" placeholder="" name="tkm_name" value="{{$tkm_report->tkm_name}}">
                  </div>

                  <div class="form-group">
                    <label for="tkm_time">Time</label>
                    <input type="time" class="form-control" id="tkm_time" placeholder="" name="tkm_time" value="{{$tkm_report->tkm_time}}">
                  </div>

                  <div class="form-group">
                    <label for="tkm_event_title">Event Title</label>
                    <input type="text" class="form-control" id="tkm_event_title" placeholder="" name="tkm_event_title" value="{{$tkm_report->tkm_event_title}}">
                  </div>

                  <div class="form-group">
                    <label for="tkm_in_association">In Association(if any)</label>
                    <input type="text" class="form-control" id="tkm_in_association" placeholder="" name="tkm_in_association" value="{{$tkm_report->tkm_in_association}}">
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="tkm_no_of_participants" placeholder="" name="tkm_no_of_participants" value="{{$tkm_report->tkm_no_of_participants}}">
                  </div>
                  
                  <div class="form-group">
                    <label for="tkm_convenors">Conveynor</label>
                    <input type="text" class="form-control" id="tkm_convenors" placeholder="" name="tkm_convenors" value="{{$tkm_report->tkm_convenors}}">
                  </div>
                  
                  <div class="form-group">
                    <label for="tkm_key_members">Key Members</label>
                    <input type="text" class="form-control" id="tkm_key_members" placeholder="" name="tkm_key_members" value="{{$tkm_report->tkm_key_members}}">
                  </div>
                   <div class="form-group">
                    <label for="tkm_sponsors">Sponsors</label>
                    <input type="text" class="form-control" id="tkm_sponsors" placeholder="" name="tkm_sponsors" value="{{$tkm_report->tkm_sponsors}}">
                  </div>
                       <div class="form-group">
                    <label for="tkm_special_thanks_to">Special Thanks</label>
                    <input type="text" class="form-control" id="tkm_special_thanks_to" placeholder="" name="tkm_special_thanks_to" value="{{$tkm_report->tkm_special_thanks_to}}">
                  </div>
                  ...
                  <!--  <div class="form-group">
                   ...
                   <div class="form-group">
                    <label for="tkm_brief_report">Brief Report</label>
                    <textarea class="form-control" id="tkm_brief_report" placeholder="NOT MORE THAN 500 WORDS" name="tkm_brief_report" value="{{$tkm_report->tkm_brief_report}}"></textarea>
                  </div>
                    <!--<div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="tkm_chaitra_aatma" placeholder="" name="tkm_chaitra_aatma" value="{{$tkm_report->tkm_chaitra_aatma}}">
                  </div>

                  <div class="form-group">
                    <label for="tkm_abtyp_members">ABTYP / BLUE BRIGADE</label>
                    <input type="text" class="form-control" id="tkm_abtyp_members" placeholder="" name="tkm_abtyp_members" value="{{$tkm_report->tkm_abtyp_members}}">
                  </div>


                  <div class="form-group">
                    <label for="tkm_chief_guest">Chief Guest</label>
                    <input type="text" class="form-control" id="tkm_chief_guest" placeholder="" name="tkm_chief_guest" value="{{$tkm_report->tkm_chief_guest}}">
                  </div>


                  <div class="form-group">
                    <label for="tkm_guest">Guests</label>
                    <input type="text" class="form-control" id="tkm_guest" placeholder="" name="tkm_guest" value="{{$tkm_report->tkm_guest}}">
                  </div>
