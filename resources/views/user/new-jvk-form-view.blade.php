                 ...
                 <tr>
                    ...
                    <td>
                        ...
                        @else
                         ...
                         <a href="{{url('user/jvk-edit-form/')}}/{{$monthyreport->id}}"><button class="btn btn-info w-100">Edit</button></a>
                         @endif
                    ...
                    <td><a href="{{ url('user/jvk_pdfview')}}/{{$monthyreport->id}}/{download}"><button class="btn btn-success w-100"><i class="fa fa-file-pdf-o" aria-hidden="true"></i> Pdf</button></a></td>
                    <td><a href="{{url('user/jvk_print')}}/{{$monthyreport->id}}" target="_blank"><button class="btn btn-info w-100"><i class="fa fa-print" aria-hidden="true"></i> Print</button></td>
