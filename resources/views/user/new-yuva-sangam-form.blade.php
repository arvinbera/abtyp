        ...
        <div class="page-main">
            ...
            <div class="app-content main-content">
                <div class="side-app">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <form method="post" action="{{ route('user.yuva-sangam-report-submit') }}" enctype="multipart/form-data" class="dropzone">
                 @csrf
              ...
              <div class="card card-primary collapsed-card">
                ...
                <div class="card-body">
                 ...
                 {{--  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="ys_no_new_members" placeholder="" name="typ_ys_no_new_members">
                  </div>
                   <div class="form-group">
                    <label for="ys_no_new_members">TKM (New Members added this month)</label>
                    <input type="text" class="form-control" id="ys_tkm" placeholder="" name="tkm_ys_no_new_members">
                  </div>
