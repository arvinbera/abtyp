        ...
        <div class="page-main">
            ...
            <div class="app-content main-content">
                <div class="side-app">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <form method="post" action="{{ route('submit-edit-tapoyaga') }}" enctype="multipart/form-data" class="dropzone">
                 @csrf
                 <input type="hidden" name="monthly_report_id" id="monthly_report_id" value="{{$monthly_report[0]->tapoyaga_monthly_report_id}}">
                 <input type="hidden" name="id" value="{{$tapoyaga_report->id}}">
                <div class="card-body">
              ...
              <div class="card card-primary collapsed-card">
                ...
                <div class="card-body">
                  ...
                  {{-- <div class="form-group">
                    ...
                    <input type="date" class="form-control" id="tapoyaga_date" placeholder="" name="tapoyaga_date" value="{{$tapoyaga_report->tapoyaga_date}}">
                  </div>
                 ...
                 <!--  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="tapoyaga_no_of_participant" placeholder="Number Of participants" name="tapoyagya_no_of_participants" value="{{$tapoyaga_report->tapoyagya_no_of_participants}}">
                  </div>
                  
                  <div class="form-group">
                    <label for="tapoyaga_participant_list">Participants List</label>
                    <input type="file" class="form-control" id="tapoyaga_participant_list" placeholder="Participants List" name="tapoyagya_Participants_List" value="{{$tapoyaga_report->tapoyagya_Participants_List}}">
                  </div>

                  <div class="form-group">
                    <label for="tapoyaga_conveynor">Convenors </label>
                    <input type="text" class="form-control" id="tapoyaga_conveynor" placeholder="" name="tapoyaga_conveynor" value="{{$tapoyaga_report->tapoyaga_conveynor}}">
                  </div>

                  <div class="form-group">
                    <label for="tapoyaga_key_member">Key Members</label>
                    <input type="text" class="form-control" id="tapoyaga_key_member" placeholder="" name="tapoyaga_key_member" value="{{$tapoyaga_report->tapoyaga_key_member}}">
                  </div>

                  <div class="form-group">
                    <label for="tapoyaga_special_thanks">Special Thanks</label>
                    <input type="text" class="form-control" id="tapoyaga_special_thanks" placeholder="" name="tapoyaga_special_thanks" value="{{$tapoyaga_report->tapoyaga_special_thanks}}">
                  </div>

                  <div class="form-group">
                    <label for="tapoyaga_brief_report">Brief Report</label>
                    <input type="text" class="form-control" id="tapoyaga_brief_report" placeholder="" name="tapoyaga_brief_report" value="{{$tapoyaga_report->tapoyaga_brief_report}}">
                  </div>
                 ...
                 <!-- <div class="form-group">
                   ...
                   <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="chaitra_aatma" placeholder="" name="tapoyaga_chaitra_aatma" value="{{$tapoyaga_report->tapoyaga_chaitra_aatma}}">
                  </div>

                   <div class="form-group">
                    <label for="tapoyaga_prepared_by">ABTYP Members</label>
                    <input type="text" class="form-control" id="abtyp_members" placeholder="" name="tapoyaga_abtyp_members" value="{{$tapoyaga_report->tapoyaga_abtyp_members}}">
                  </div>
