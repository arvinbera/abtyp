        ...
        <div class="page-main">
            ...
            <div class="app-content main-content">
                <div class="side-app">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <form method="post" action="{{ route('submit-edit-jsv') }}" enctype="multipart/form-data" class="dropzone">
                 @csrf
                 <input type="hidden" name="monthly_report_id" id="monthly_report_id" value="{{$monthly_report[0]->jsv_monthly_report_id}}">
                 <input type="hidden" name="id" value="{{$jsv_report->id}}">
                <div class="card-body">
              ...
              <div class="card card-primary collapsed-card">
                ...
                <div class="card-body">
                  ...
                  {{-- <div class="form-group">
                    ...
                    <input type="date" class="form-control" id="jsv_date" placeholder="Date" name="jsv_date" value="{{$jsv_report->jsv_date}}">
                  </div>

                  <div class="form-group">
                    <label for="jsv_time">Time</label>
                    <input type="time" class="form-control" id="jsv_time" placeholder="Time" name="jsv_time" value="{{$jsv_report->jsv_time}}">
                  </div>

                  <div class="form-group">
                    <label for="jsv_venue">Venue</label>
                    <input type="text" class="form-control" id="jsv_venue" placeholder="Venue" name="jsv_venue" value="{{$jsv_report->jsv_venue}}">
                  </div>
                 ...
                 <!--  <div class="form-group">
                   ...
                   <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="jsv_sanskar_name" placeholder="Sanskar's Name" name="jsv_sanskar_name" value="{{$jsv_report->jsv_sanskar_name}}">
                  </div>

                  <div class="form-group">
                    <label for="jsv_no_of_participant">Number Of participants</label>
                    <input type="text" class="form-control" id="jsv_no_of_participant" placeholder="Number Of participants" name="jsv_no_of_participant" value="{{$jsv_report->jsv_no_of_participant}}">
                  </div>

                  <div class="form-group">
                    <label for="jsv_convenors">Convenors</label>
                    <input type="text" class="form-control" id="jsv_convenors" placeholder="Convenors" name="jsv_convenors" value="{{$jsv_report->jsv_convenors}}">
                  </div>

                  <div class="form-group">
                    <label for="jsv_key_member">Key Members</label>
                    <input type="text" class="form-control" id="jsv_key_member" placeholder="Key Members" name="jsv_key_member" value="{{$jsv_report->jsv_key_member}}">
                  </div>

                  <div class="form-group">
                    <label for="jsv_sponsors">Sponsors</label>
                    <input type="text" class="form-control" id="jsv_sponsors" placeholder="Sponsors" name="jsv_sponsors" value="{{$jsv_report->jsv_sponsors}}">
                  </div>


                  <div class="form-group">
                    <label for="jsv_specila_thanks_to">Special Thanks To</label>
                    <input type="text" class="form-control" id="jsv_specila_thanks_to" placeholder="Special Thanks To" name="jsv_specila_thanks_to" value="{{$jsv_report->jsv_specila_thanks_to}}">
                  </div>

                   <div class="form-group">
                    <label for="jsv_brief_report">Brief Report</label>
                    <input type="text" class="form-control" id="jsv_brief_report" placeholder="Brief Report" name="jsv_brief_report" value="{{$jsv_report->jsv_brief_report}}">
                  </div>

                   <div class="form-group">
                    <label for="jsv_chaitra_aatma">Chaitra Aatma</label>
                    <input type="text" class="form-control" id="jsv_chaitra_aatma" placeholder="Chaitra Aatma" name="jsv_chaitra_aatma" value="{{$jsv_report->jsv_chaitra_aatma}}">
                  </div>

                   <div class="form-group">
                    <label for="jsv_abtyp_members">ABTYP Members</label>
                    <input type="text" class="form-control" id="jsv_abtyp_members" placeholder="ABTYP Members" name="jsv_abtyp_members" value="{{$jsv_report->jsv_abtyp_members}}">
                  </div>

                  <div class="form-group">
                    <label for="jsv_chief_guest">Chief Guest</label>
                    <input type="text" class="form-control" id="jsv_chief_guest" placeholder="Chief Guest" name="jsv_chief_guest" value="{{$jsv_report->jsv_chief_guest}}">
                  </div>

                  <div class="form-group">
                    <label for="jsv_guest">Guests</label>
                    <input type="text" class="form-control" id="jsv_guest" placeholder="Guests" name="jsv_guest" value="{{$jsv_report->jsv_guest}}">
                  </div>
