        ...
        <div class="page-main">
            ...
            <div class="app-content main-content">
                <div class="side-app">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <form method="post" action="{{ route('submit-edit-cps') }}" enctype="multipart/form-data" class="dropzone">
                 @csrf
                 <input type="hidden" name="monthly_report_id" id="monthly_report_id" value="{{$monthly_report[0]->cps_monthly_report_id}}">
                 <input type="hidden" name="id" value="{{$cps_report->id}}">
                <div class="card-body">
              ...
              <div class="card card-primary collapsed-card">
                ...
                <div class="card-body" >
                  ...
                  {{-- <div class="form-group">
                    ...
                    <input type="date" class="form-control" id="cps_date_form" placeholder="" name="cps_date" value="{{$cps_report->cps_date}}">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="cps_venue" placeholder="" name="cps_venue" value="{{$cps_report->cps_venue}}">
                  </div>

                  <div class="form-group">
                    <label for="cps_in_association">In Association(if any)</label>
                    <input type="text" class="form-control" id="cps_in_association" placeholder="" name="cps_in_association" value="{{$cps_report->cps_in_association}}">
                  </div>
                  
                    <label for="">ABOUT THE PROGRAM</label>
                    <div class="form-group">
                    <label for="cps_teachers_name">Faculty Name (4 - 5 Names)</label>
                    <input type="text" class="form-control" id="cps_Faculty_Name" placeholder="" name="cps_Faculty_Name" value="{{$cps_report->cps_Faculty_Name}}">
                  </div>
                  <div class="form-group">
                    <label for="cps_no_of_the_paticipants">NUMBER OF PARTICIPANTS: </label>
                    <input type="text" class="form-control" id="cps_NUMBER_OF_PARTICIPANTS" placeholder="" name="cps_NUMBER_OF_PARTICIPANTS" value="{{$cps_report->cps_NUMBER_OF_PARTICIPANTS}}">
                  </div>
                  
                  <div class="form-group">
                    <label for="cps_conveynor">Conveynor</label>
                    <input type="text" class="form-control" id="cps_conveynor" placeholder="" name="cps_conveynor" value="{{$cps_report->cps_conveynor}}">
                  </div>
                  
                  <div class="form-group">
                    <label for="cps_key_members">Key Members</label>
                    <input type="text" class="form-control" id="cps_key_members" placeholder="" name="cps_key_member" value="{{$cps_report->cps_key_member}}">
                  </div>
                   <div class="form-group">
                    <label for="cps_sponcer">Sponsors</label>
                    <input type="text" class="form-control" id="cps_sponcer" placeholder="" name="cps_sponcer" value="{{$cps_report->cps_sponcer}}">
                  </div>
                       <div class="form-group">
                    <label for="cps_special_thanks">Special Thanks</label>
                    <input type="text" class="form-control" id="cps_special_thanks" placeholder="" name="cps_special_thanks" value="{{$cps_report->cps_special_thanks}}">
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="cps_chaitra_aatma" placeholder="" name="cps_chaitra_aatma" value="{{$cps_report->cps_chaitra_aatma}}">
                  </div>

                  <div class="form-group">
                    <label for="cps_abtyp_members">ABTYP Members</label>
                    <input type="text" class="form-control" id="cps_abtyp_members" placeholder="" name="cps_abtyp_members" value="{{$cps_report->cps_abtyp_members}}">
                  </div>


                  <div class="form-group">
                    <label for="cps_chief_guest">Chief Guest</label>
                    <input type="text" class="form-control" id="cps_chief_guest" placeholder="" name="cps_chief_guest" value="{{$cps_report->cps_chief_guest}}">
                  </div>


                  <div class="form-group">
                    <label for="cps_guest">Guests</label>
                    <input type="text" class="form-control" id="cps_guest" placeholder="" name="cps_guest" value="{{$cps_report->cps_guest}}">
                  </div>
