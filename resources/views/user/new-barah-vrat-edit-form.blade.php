        ...
        <div class="page-main">
            ...
            <div class="app-content main-content">
                <div class="side-app">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <form method="post" action="{{ route('submit-barah-vrat') }}" enctype="multipart/form-data" class="dropzone">
                 @csrf
                 <input type="hidden" name="monthly_report_id" id="monthly_report_id" value="{{$monthly_report[0]->bv_monthly_report_id}}">
                 <input type="text" name="id" value="{{$barah_report->id}}">
                <div class="card-body">
              ...
              <div class="card card-primary collapsed-card">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="bv_venue" placeholder="" name="bv_venue" value="{{$barah_report->bv_venue}}">
                  </div>

                  <div class="form-group">
                    <label for="bv_in_association">In Association(if any)</label>
                    <input type="text" class="form-control" id="bv_in_association" placeholder="" name="bv_in_association" value="{{$barah_report->bv_in_association}}">
                  </div>

                   <div class="form-group">
                    <label for="bv_sanskar_name">Speaker's Name</label>
                    <input type="text" class="form-control" id="bv_sanskar_name" placeholder="" name="bv_sanskar_name" value="{{$barah_report->bv_sanskar_name}}">
                  </div>

                  <div class="form-group">
                    <label for="bv_no_of_participant">Number Of participants</label>
                    <input type="text" class="form-control" id="bv_no_of_participant" placeholder="" name="bv_no_of_participant" value="{{$barah_report->bv_no_of_participant}}">
                  </div>

                  <div class="form-group">
                    <label for="bv_convenors">Convenors</label>
                    <input type="text" class="form-control" id="bv_convenors" placeholder="" name="bv_convenors" value="{{$barah_report->bv_convenors}}">
                  </div>

                  <div class="form-group">
                    <label for="bv_key_members">Key Members</label>
                    <input type="text" class="form-control" id="bv_key_members" placeholder="" name="bv_key_members" value="{{$barah_report->bv_key_members}}">
                  </div>

                  <div class="form-group">
                    <label for="bv_sponsors">Sponsors</label>
                    <input type="text" class="form-control" id="bv_sponsors" placeholder="" name="bv_sponsors" value="{{$barah_report->bv_sponsors}}">
                  </div>


                  <div class="form-group">
                    <label for="bv_special_thanks_to">Special Thanks To</label>
                    <input type="text" class="form-control" id="bv_special_thanks_to" placeholder="" name="bv_special_thanks_to" value="{{$barah_report->bv_special_thanks_to}}">
                  </div>

                   <div class="form-group">
                    <label for="bv_brief_report">Brief Report</label>
                    <input type="text" class="form-control" id="bv_brief_report" placeholder="" name="bv_brief_report" value="{{$barah_report->bv_brief_report}}">
                  </div>
                   ...
                   <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="bv_abtyp_members" placeholder="" name="bv_abtyp_members" value="{{$barah_report->bv_abtyp_members}}">
                  </div>

                  <div class="form-group">
                    <label for="bv_chief_guest">Chief Guest</label>
                    <input type="text" class="form-control" id="bv_chief_guest" placeholder="" name="bv_chief_guest" value="{{$barah_report->bv_chief_guest}}">
                  </div>

                  <div class="form-group">
                    <label for="bv_guets">Guests</label>
                    <input type="text" class="form-control" id="bv_guets" placeholder="" name="bv_guets" value="{{$barah_report->bv_guets}}">
                  </div>
