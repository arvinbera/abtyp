   ...
   <!--               <form method="post" action="{{ route('user.monthly-report_filer') }}">
                ...
                <div class="row">
                        ...
                        <div class="col-12">
                            <div class="card">
									<div class="card-header">
										<div class="card-title">YUVA VAHINI Monthly Report</div>
									</div>
									<div class="card-body">
                  ...
                  <tr>
                    ...
                    <th class="wd-15p border-bottom-0">Date Form</th>
                    <th class="wd-15p border-bottom-0">Date To</th>
                    <th class="wd-15p border-bottom-0">Number of Days</th>
                    <th class="wd-15p border-bottom-0">Number of Members</th>
                    <th class="wd-15p border-bottom-0">Total Distance Covered</th>
                    <th class="wd-15p border-bottom-0">Number of YV Jackets Collected</th>
                    <th class="wd-15p border-bottom-0">Availed Abtyp's Accomodation</th>
                    <th class="wd-15p border-bottom-0">Availed Satkar</th>
                 ...
                 <tr>
                    ...
                    <td>{{ $monthyreport->yuva_vahini_date_form }}</td>
                    <td>{{ $monthyreport->yuva_vahini_date_to }}</td>
                    <td>{{ $monthyreport->yuva_vahini_no_Of_days }}</td>
                    <td>{{ $monthyreport->yuva_vahini_no_of_members }}</td>
                    <td>{{ $monthyreport->yuva_vahini_total_distance }}</td>
                    <td>{{ $monthyreport->yuva_vahini_no_of_yv_jackets_collected }}</td>
                    <td>{{ $monthyreport->yuva_vahini_availed_abtyp_accomodation }}</td>
                    <td>{{ $monthyreport->yuva_vahini_availed_satkar }}</td>
                    <td>{{ $monthyreport->yuva_vahini_brief_report }}</td>
                    ...
                    <td>
                        @if($monthyreport->status == 'pending')
                         <a href="{{url('branch/yv-status/'.$monthyreport->id)}}"><button class="btn btn-warning w-100">Pending</button></a>
                        @else
                        <a href="#"><button class="btn btn-success w-100">Accept</button></a>
                        @endif
                    </td>
                    <td><a href="{{url('branch/yuvavahini_pdfview')}}/{{$monthyreport->id}}/{download}"><button class="btn btn-success w-100"><i class="fa fa-file-pdf-o" aria-hidden="true"></i> Pdf</button></a></td>
                    <td><a href="{{url('branch/yv_print')}}/{{$monthyreport->id}}" target="_blank"><button class="btn btn-info w-100"><i class="fa fa-print" aria-hidden="true"></i> Print</button></td>
