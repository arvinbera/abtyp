                 ...
                 <tr>
                    ...
                    <td>{{ $monthyreport->filled_by_role }}</td>
                        ...
                        @if($monthyreport->status == 'pending')
                         <a href="{{url('branch/mbdd-status/'.$monthyreport->id)}}"><button class="btn btn-warning w-100">Pending</button></a>
                        @else
                    ...
                    <td><a href="{{url('branch/mbdd_pdfview')}}/{{$monthyreport->id}}/{download}"><button class="btn btn-success w-100"><i class="fa fa-file-pdf-o" aria-hidden="true"></i> Pdf</button></a></td>
