...
<tbody>
  ...
  <tr>
    ...
    <td class="tg-baqh">{{ $items->choka_satkar_date_form }}</td>
  ...
  <tr>
    ...
    <td class="tg-baqh">{{ $items->choka_satkar_date_to }}</td>
  ...
  <tr>
    ...
    <td class="tg-baqh">{{ $items->choka_satkar_time }}</td>
   
  </tr>

   <tr>
    <td class="tg-0lax">Number of Days</td>
    <td class="tg-baqh">{{ $items->choka_satkar_no_of_days }}</td>
  ...
  <tr>
    ...
    <td class="tg-baqh">{{ $items->choka_satkar_amount_paid }}</td>
   ...
   <tr>
    ...
    <td class="tg-baqh">{{ $items->choka_satkar_sponsor }}</td>
   
  </tr>
   <tr>
    <td class="tg-0lax">In Association(if any)</td>
    <td class="tg-baqh">{{ $items->choka_satkar_in_association }}</td>
   
  </tr>
   <tr>
    <td class="tg-0lax">Special Thanks To</td>
    <td class="tg-baqh">{{ $items->choka_satkar_special_thanks_to }}</td>
   
  </tr>
   <tr>
    <td class="tg-0lax">Brief Report</td>
    <td class="tg-baqh">{{ $items->choka_satkar_brief_reports }}</td>
   
  </tr>
   <tr>
    <td class="tg-0lax">Prepared By</td>
    <td class="tg-baqh">{{ $items->choka_satkarprepared_by }}</td>
