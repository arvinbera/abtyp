      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            ...
            <!-- ===========================Filter Start ================================== -->
                 <form method="post" action="{{ route('branch.ampk-report-filter') }}">
                @csrf
             ...
             <table id="example" class="display nowrap" style="width:100%">
                 ...
                 <tr>
                    ...
                    <td>{{ $ampk->username }}</td>
                    <td><?php $newDateFormat2 = date('M/Y', strtotime($ampk)); echo $newDateFormat2; ?>
                    ...
                    <td>{{ $ampk->ampk_prepared_by }}</td>
                      <td><a href="{{url('/branch/ampk-edit')}}/{{$ampk->id}}">Edit</a></td>
                      <td><a href="{{ route('ampk-pdfview',['id'=>$ampk->id, 'monthly_report_month'=>$ampk->monthly_report_month,'download'=>'pdf']) }}"><i class="fas fa-download"></i></a></td>
                   <td><a href="{{url('branch/ampk-print')}}/{{$ampk->id}}" target="_blank"><i class="fas fa-print"></i></a></td>
