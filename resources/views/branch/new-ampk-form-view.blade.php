   ...
   <!--               <form method="post" action="{{ route('user.monthly-report_filer') }}">
                ...
                <div class="row">
                        ...
                        <div class="col-12">
                            <div class="card">
									<div class="card-header">
										<div class="card-title">AMPK Monthly Report</div>
									</div>
									<div class="card-body">
                  ...
                  <tr>
                    ...
                    <th class="wd-15p border-bottom-0">Chaitra Aatma's Visited</th>
                 ...
                 <tr>
                    ...
                    <td>{{ $monthyreport->ampk_in_association }}</td>
                    <td>{{ $monthyreport->ampk_chaitra_atma_visited }}</td>
                    <td>{{ $monthyreport->ampk_date }}</td>
                    <td>{{ $monthyreport->ampk_conveynor }}</td>
                    <td>{{ $monthyreport->ampk_key_members }}</td>
                    <td>{{ $monthyreport->ampk_sponsors }}</td>
                    <td>{{ $monthyreport->ampk_special_thanks_to }}</td>
                    <td>{{ $monthyreport->ampk_brief_report }}</td>
                   ...
                   <td>
                        @if($monthyreport->status == 'pending')
                         <a href="{{url('branch/ampk-status/'.$monthyreport->id)}}"><button class="btn btn-warning w-100">Pending</button></a>
                        @else
                        <a href="#"><button class="btn btn-success w-100">Accept</button></a>
                        @endif
                    </td>
                    <td><a href="{{url('branch/ampk_pdfview')}}/{{$monthyreport->id}}/{download}"><button class="btn btn-success w-100"><i class="fa fa-file-pdf-o" aria-hidden="true"></i> Pdf</button></a></td>
                    <td><a href="{{url('branch/ampk_print')}}/{{$monthyreport->id}}" target="_blank"><button class="btn btn-info w-100"><i class="fa fa-print" aria-hidden="true"></i> Print</button></td>
