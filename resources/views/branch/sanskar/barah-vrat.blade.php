          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <!-- ===========================Filter Start ================================== -->
                 <form method="post" action="{{ route('branch.barahvarat-report-filter') }}">
                @csrf
                 ...
                 <tr>
                    ...
                    <td><?php $newDateFormat2 = date('M/Y', strtotime($bvl->monthly_report_month)); echo $newDateFormat2; ?>
                     ...
                     <td>{{ $bvl->bv_prepared_by }}</td>
                       <td><a href="{{url('/branch/bvl-edit')}}/{{$bvl->id}}">Edit</a></td>
                        <td><a href="{{ route('barah-varat-pdfview',['id'=>$bvl->id, 'monthly_report_month'=>$bvl->monthly_report_month,'download'=>'pdf']) }}"><i class="fas fa-download"></i></a></td>
                     <td><a href="{{url('branch/bvl-print')}}/{{$bvl->id}}" target="_blank"><i class="fas fa-print"></i></a></td>
