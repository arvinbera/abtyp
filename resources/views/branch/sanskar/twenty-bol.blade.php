          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
               <!-- ===========================Filter Start ================================== -->
                 <form method="post" action="{{ route('branch.twentyfivebol-report-filter') }}">
                @csrf
                 ...
                 <tr>
                    ...
                    <td><?php $newDateFormat2 = date('M/Y', strtotime($tfbl->monthly_report_month)); echo $newDateFormat2; ?>
                     ...
                     <td>{{ $tfbl->tbol_preapred_by }}</td>
                       <td><a href="{{url('/branch/twenty-five-bol-edit')}}/{{$tfbl->id}}">Edit</a></td>
                       <td><a href="{{ route('twenty-five-bol-pdfview',['id'=>$tfbl->id, 'monthly_report_month'=>$tfbl->monthly_report_month,'download'=>'pdf']) }}"><i class="fas fa-download"></i></a></td>
                   <td><a href="{{url('branch/tfbl-print')}}/{{$tfbl->id}}" target="_blank"><i class="fas fa-print"></i></a></td>
