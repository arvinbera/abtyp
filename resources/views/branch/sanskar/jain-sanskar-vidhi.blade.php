          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <!-- ===========================Filter Start ================================== -->
                 <form method="post" action="{{ route('branch.jsv-report-filter') }}">
                @csrf
                   ...
                   <td>{{ $loop->iteration }}</td>
                    ...
                    <td><?php $newDateFormat2 = date('M/Y', strtotime($jsv->monthly_report_month)); echo $newDateFormat2; ?>
                     ...
                     <td>{{ $jsv->jsv_prepared_by }}</td>
                       <td><a href="{{url('/branch/jsv-edit')}}/{{$jsv->id}}">Edit</a></td>
                       <td><a href="{{ route('jsv-pdfview',['id'=>$jsv->id, 'monthly_report_month'=>$jsv->monthly_report_month,'download'=>'pdf']) }}"><i class="fas fa-download"></i></a></td>
                     <td><a href="{{url('branch/jsv-print')}}/{{$jsv->id}}" target="_blank"><i class="fas fa-print"></i></a></td>
