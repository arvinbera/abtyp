          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                 <!-- ===========================Filter Start ================================== -->
                 <form method="post" action="{{ route('branch.tapoyagya-report-filter') }}">
                @csrf
                 ...
                 <tr>
                    ...
                    <td><?php $newDateFormat2 = date('M/Y', strtotime($tapoyagya->monthly_report_month)); echo $newDateFormat2; ?>
                      ...
                      <td>{{ $tapoyagya->tapoyaga_prepared_by  }}</td>
                       <td><a href="{{url('/branch/tapoyagya-edit')}}/{{$tapoyagya->id}}">Edit</a></td>
                       <td><a href="{{ route('tapoyagya-pdfview',['id'=>$tapoyagya->id, 'monthly_report_month'=>$tapoyagya->monthly_report_month,'download'=>'pdf']) }}"><i class="fas fa-download"></i></a></td>
                    <td><a href="{{url('branch/tapoyagya-print')}}/{{$tapoyagya->id}}" target="_blank"><i class="fas fa-print"></i></a></td>
