    ...
    <section class="content">
      <div class="container-fluid">
        <div class="row">
          ...
          <!-- ===========================Filter Start ================================== -->
                 <form method="post" action="{{ route('branch.samayiksadhak-report-filter') }}">
                @csrf
              ...
              <table id="example" class="display nowrap" style="width:100%">
                 ...
                 <tr>
                    ...
                    <td>{{ $ss->ss_prepared_by   }}</td>
                       <td><a href="{{url('/branch/samayik-sadhak-edit')}}/{{$ss->id}}">Edit</a></td>
                       <td><a href="{{ route('ss-pdfview',['id'=>$ss->id, 'monthly_report_month'=>$ss->monthly_report_month,'download'=>'pdf']) }}"><i class="fas fa-download"></i></a></td>
                    <td><a href="{{url('branch/yuvasangam-print')}}/{{$ss->id}}" target="_blank"><i class="fas fa-print"></i></a></td>
