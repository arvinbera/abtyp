                    ...
                    <!-- Row-1 -->
                     <div class="row">
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-xm-12">
                            <div class="card overflow-hidden dash1-card border-0">
                                <div class="card-body">
                                    <p class=" mb-1 ">Total Report Submitted</p>
                                    <?php $tot_mem=DB::Table('yuva_sangam_form_details')->count(); ?>
                                    <h2 class="mb-1 number-font">20</h2>
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-xm-12">
                            <div class="card overflow-hidden dash1-card border-0">
                                <div class="card-body">
                                    <p class=" mb-1 ">Total Slot Booked</p>
                                    <?php $tot_mem=DB::Table('yuva_sangam_form_details')->where('status','=','Pending')->count(); ?>
                           ...
                           <!-- <div class="card overflow-hidden dash1-card border-0">
                                <div class="card-body">
                                    ...
                                    <?php
                                     ...
                                     $tot_data=DB::Table('welcome_form_prashid_details')->count();
