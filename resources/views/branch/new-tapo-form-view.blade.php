   ...
   <!--               <form method="post" action="{{ route('user.monthly-report_filer') }}">
                ...
                <div class="row">
                        ...
                        <div class="col-12">
                            <div class="card">
									<div class="card-header">
										<div class="card-title">Tapoyagya Monthly Report</div>
									</div>
									<div class="card-body">
                 ...
                 <tr>
                    ...
                    <td>{{ $monthyreport->tapoyaga_date }}</td>
                    <td>{{ $monthyreport->tapoyagya_no_of_participants }}</td>
                 
                    <td>{{ $monthyreport->tapoyaga_conveynor }}</td>
                    <td>{{ $monthyreport->tapoyaga_key_member }}</td>
                    <td>{{ $monthyreport->tapoyaga_special_thanks }}</td>
                    <td>{{ $monthyreport->tapoyaga_brief_report }}</td>
                    <td>{{ $monthyreport->tapoyaga_chaitra_aatma }}</td>
                    <td>{{ $monthyreport->tapoyaga_abtyp_members }}</td>
                ...
                <td>
                        @if($monthyreport->status == 'pending')
                         <a href="{{url('branch/tapo-status/'.$monthyreport->id)}}"><button class="btn btn-warning w-100">Pending</button></a>
                        @else
                        <a href="#"><button class="btn btn-success w-100">Accept</button></a>
                        @endif
                    </td>
                    <td><a href="{{url('branch/tapoyagya_pdfview')}}/{{$monthyreport->id}}/{download}"><button class="btn btn-success w-100"><i class="fa fa-file-pdf-o" aria-hidden="true"></i> Pdf</button></a></td>
                    <td><a href="{{url('branch/tapoyagya_print')}}/{{$monthyreport->id}}" target="_blank"><button class="btn btn-info w-100"><i class="fa fa-print" aria-hidden="true"></i> Print</button></td>
