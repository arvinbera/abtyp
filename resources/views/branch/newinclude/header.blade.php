                        ...
                        <div class="container-fluid">
                            <div class="d-flex">
                                ...
                                <div class="app-sidebar__toggle" data-toggle="sidebar">
                                    <a class="open-toggle" href="{{route('branch.stat_dashboard')}}">
                                ...
                                <div class="d-flex order-lg-2 ml-auto">
                                            ...
                                            <div class="header-dropdown-list message-menu" id="message-menu">
                                                <a class="dropdown-item border-bottom" href="index.html#">
                                                    <div class="d-flex align-items-center">
                                                        <div class="">
                                                            <span class="avatar avatar-md brround align-self-center cover-image" data-image-src="{{url('/')}}/public/admin/assets/images/users/1.jpg"></span>
                                                        </div>
                                                        <div class="d-flex">
                                                            <div class="pl-3">
                                                ...
                                                <a class="dropdown-item border-bottom">
                                                    <div class="d-flex align-items-center">
                                                        <div class="">
                                                            <span class="avatar avatar-md brround align-self-center cover-image" data-image-src="{{url('/')}}/public/admin/assets/images/users/2.jpg"></span>
                                                        </div>
                                                        <div class="d-flex">
                                                            <div class="pl-3">
                                                ...
                                                <a class="dropdown-item border-bottom">
                                                    <div class="d-flex align-items-center">
                                                        <div class="">
                                                            <span class="avatar avatar-md brround align-self-center cover-image" data-image-src="{{url('/')}}/public/admin/assets/images/users/3.jpg"></span>
                                                        </div>
                                                        <div class="d-flex">
                                                            <div class="pl-3">
                                                ...
                                                <a class="dropdown-item border-bottom">
                                                    <div class="d-flex align-items-center">
                                                        <div class="">
                                                            <span class="avatar avatar-md brround align-self-center cover-image" data-image-src="{{url('/')}}/public/admin/assets/images/users/4.jpg"></span>
                                                        </div>
                                                        <div class="d-flex">
                                                            <div class="pl-3">
                                                ...
                                                <a class="dropdown-item border-bottom">
                                                    <div class="d-flex align-items-center">
                                                        <div class="">
                                                            <span class="avatar avatar-md brround align-self-center cover-image" data-image-src="{{url('/')}}/public/admin/assets/images/users/6.jpg"></span>
                                                        </div>
                                                        <div class="d-flex">
                                                            <div class="pl-3">
                                                ...
                                                <a class="dropdown-item border-bottom">
                                                    <div class="d-flex align-items-center">
                                                        <div class="">
                                                            <span class="avatar avatar-md brround align-self-center cover-image" data-image-src="{{url('/')}}/public/admin/assets/images/users/7.jpg"></span>
                                                        </div>
                                                        <div class="d-flex">
                                                            <div class="pl-3">
                                    ...
                                    <div class="dropdown profile-dropdown">
                                        <a href="index.html#" class="nav-link pr-0 leading-none" data-toggle="dropdown">
                                            <span>
                                                <img src="{{url('/')}}/public/images/logo.png" alt="img" class="avatar1 avatar-md brround">
                                            </span>
                                        </a>
                                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow animated">
                                            <!-- <div class="text-center">
                                                <a href="index.html#" class="dropdown-item text-center user pb-0 font-weight-bold">Jessica</a>
                                            ...
                                            <a class="dropdown-item d-flex" href="{{url('/branch/logout')}}">
