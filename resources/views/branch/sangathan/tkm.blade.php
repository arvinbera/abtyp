      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
           ...
           <!-- ===========================Filter Start ================================== -->
                 <form method="post" action="{{ route('branch.ttk-report-filter') }}">
                @csrf
                   ...
                   <td>{{ $loop->iteration }}</td>
                    ...
                    <td><?php $newDateFormat2 = date('M/Y', strtotime($ttk->monthly_report_month)); echo $newDateFormat2; ?>
                     ...
                     <td>{{ $ttk->tkm_prepared_by }}</td>
                         <td><a href="{{url('/branch/ttk-edit')}}/{{$ttk->id}}">Edit</a></td>
                         <td><a href="{{ route('tkm-pdfview',['id'=>$ttk->id, 'monthly_report_month'=>$ttk->monthly_report_month,'download'=>'pdf']) }}"><i class="fas fa-download"></i></a></td>
                     <td><a href="{{url('branch/ttk-print')}}/{{$ttk->id}}" target="_blank"><i class="fas fa-print"></i></a></td>
