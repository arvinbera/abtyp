      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
           ...
           <!-- ===========================Filter Start ================================== -->
                 <form method="post" action="{{ route('branch.fityuva-report-filter') }}">
                @csrf
                 ...
                 <tr>
                    ...
                    <td><?php $newDateFormat2 = date('M/Y', strtotime($fityuva->monthly_report_month)); echo $newDateFormat2; ?>
                     ...
                     <td>{{ $fityuva->fit_yuva_prepared_by }}</td>
                            <td><a href="{{url('/branch/fityuva-edit')}}/{{$fityuva->id}}">Edit</a></td>
                            <td><a href="{{ route('fittyuva-pdfview',['id'=>$fityuva->id, 'monthly_report_month'=>$fityuva->monthly_report_month,'download'=>'pdf']) }}"><i class="fas fa-download"></i></a></td>
                    <td><a href="{{url('branch/fityuva-print')}}/{{$fityuva->id}}" target="_blank"><i class="fas fa-print"></i></a></td>
